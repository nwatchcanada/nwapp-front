...
import {
    ...
    WORKERY_ITEM_ARCHIVE_API_OPERATION_ENDPOINT
} from '../constants/api';
...
export function postItemDeactivationDetail(postData, onSuccessCallback, onFailureCallback) {
    return dispatch => {
        // Change the global state to attempting to log in.
        store.dispatch(
            setItemDetailRequest()
        ...
        // Perform our API submission.
        customAxios.post(WORKERY_ITEM_ARCHIVE_API_OPERATION_ENDPOINT, buffer).then( (successResponse) => {
            // Decode our MessagePack (Buffer) into JS Object.
            const responseData = msgpack.decode(Buffer(successResponse.data));
            ...
            if (exception.response) {
                ...
                console.log("postItemDeactivationDetail | error:", errors); // For debuggin purposes only.
