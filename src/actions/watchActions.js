...
import {
    ...
    WORKERY_WATCH_INFORMATION_UPDATE_API_ENDPOINT,
    WORKERY_WATCH_STREET_MEMBERSHIP_UPDATE_API_ENDPOINT,
    WORKERY_WATCH_METRICS_UPDATE_API_ENDPOINT,
    NWAPP_WATCH_BOUNDRY_OPERATION_API_ENDPOINT
} from '../constants/api';
...
export function putWatchInformation(data, onSuccessCallback, onFailureCallback) {
    return dispatch => {
        // Change the global state to attempting to log in.
        store.dispatch(
            setWatchDetailRequest()
        ...
        // Perform our API submission.
        customAxios.put(WORKERY_WATCH_INFORMATION_UPDATE_API_ENDPOINT.replace("XXX", data.slug), buffer).then( (successResponse) => {
            // Decode our MessagePack (Buffer) into JS Object.
            const responseData = msgpack.decode(Buffer(successResponse.data));
            let watch = camelizeKeys(responseData);
            ...
            if (exception.response) {
                ...
                console.log("putWatchInformation | error:", errors); // For debuggin purposes only.
...
export function putWatchStreetMembership(data, onSuccessCallback, onFailureCallback) {
    return dispatch => {
        // Change the global state to attempting to log in.
        store.dispatch(
            setWatchDetailRequest()
        ...
        // Perform our API submission.
        customAxios.put(WORKERY_WATCH_STREET_MEMBERSHIP_UPDATE_API_ENDPOINT.replace("XXX", data.slug), buffer).then( (successResponse) => {
            // Decode our MessagePack (Buffer) into JS Object.
            const responseData = msgpack.decode(Buffer(successResponse.data));
            let watch = camelizeKeys(responseData);
            ...
            if (exception.response) {
                ...
                console.log("putWatchStreetMembership | error:", errors); // For debuggin purposes only.
...
export function putWatchBoundryOperation(data, onSuccessCallback, onFailureCallback) {
    return dispatch => {
        // Change the global state to attempting to log in.
        store.dispatch(
            setWatchDetailRequest()
        ...
        // Perform our API submission.
        customAxios.put(NWAPP_WATCH_BOUNDRY_OPERATION_API_ENDPOINT.replace("<slug>", data.slug), buffer).then( (successResponse) => {
            // Decode our MessagePack (Buffer) into JS Object.
            const responseData = msgpack.decode(Buffer(successResponse.data));
            let watch = camelizeKeys(responseData);
            ...
            if (exception.response) {
                ...
                console.log("putWatchBoundryOperation | error:", errors); // For debuggin purposes only.
