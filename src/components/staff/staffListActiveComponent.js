...
class StaffActiveListComponent extends Component {
    render() {
                        ...
                        <section className="row text-center placeholders">
                            ...
                            <div className="col-sm-6 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-dgreen">
                                    <Link to="/staff/active/search" className="d-block link-ndecor" title="Search">
...
export default StaffActiveListComponent;
