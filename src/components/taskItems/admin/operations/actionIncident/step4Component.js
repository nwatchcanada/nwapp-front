...
class ActionIncidentTaskStep4Component extends Component {
    render() {
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/task/4/${uuid}/step-3`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default ActionIncidentTaskStep4Component;
