...
class ActionIncidentTaskStep1Component extends Component {
    ...
    render() {
        ...
        const { uuid, keyword, firstName, lastName, telephone, email, errors, isLoading } = this.props;
        return (
            <div>
...
export default ActionIncidentTaskStep1Component;
