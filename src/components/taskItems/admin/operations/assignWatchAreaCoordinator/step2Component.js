...
class AssignWatchAreaCoordinatorTaskStep1Component extends Component {
    render() {
        const { areaCoordinator, areaCoordinatorOptions, uuid, errors, onSelectChange, isLoading, onClick } = this.props;
        return (
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/task/1/${uuid}/step-1`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
