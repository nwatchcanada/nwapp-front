...
class ActionConcernItemTaskStep1Component extends Component {
    render() {
                ...
                <div className="ow">
                    <div className="col-md-10 mx-auto p-2">
                        <table className="table table-bordered custom-cell-w">
                            ...
                            <tr>
                                <th scope="row" className="bg-light">Concern:</th>
...
export default ActionConcernItemTaskStep1Component;
