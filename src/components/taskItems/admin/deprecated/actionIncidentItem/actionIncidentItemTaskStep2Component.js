...
class ActionIncidentItemTaskStep2Component extends Component {
    render() {
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/task/4/${slug}/step-1`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default ActionIncidentItemTaskStep2Component;
