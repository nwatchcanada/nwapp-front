...
class ActionIncidentItemTaskStep1Component extends Component {
    render() {
                ...
                <div className="ow">
                    <div className="col-md-10 mx-auto p-2">
                        <table className="table table-bordered custom-cell-w">
                            ...
                            <tr>
                                <th scope="row" className="bg-light">Incident:</th>
                                <td>Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum Loren ipsum </td>
                            </tr>
                            <tr>
...
export default ActionIncidentItemTaskStep1Component;
