...
export default class AdminStaffFileUploadArchiveComponent extends Component {
    render() {
        const {
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/staff/${slug}/files`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
