...
function detailLinkFormatter(cell, row){
    if (row.isArchived === true) {
        ...
        return (
            <Link to={`/admin/staff/${row.user}/community/award/archive/${row.uuid}`}>
...
class AdminStaffAwardListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
...
export default AdminStaffAwardListComponent;
