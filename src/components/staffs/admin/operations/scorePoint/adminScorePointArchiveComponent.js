...
export default class AdminStaffScorePointArchiveComponent extends Component {
    render() {
        const {
            isLoading, slug, staff, errors, onClick
        } = this.props;
        return (
            <div>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/staff/${slug}/community/score-points`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
