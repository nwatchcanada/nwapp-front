...
function fileFormatter(cell, row){
    return (
        <div>
            ...
            &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
            {row.isArchived === false &&
                <Link to={`/admin/staff/${row.user}/file/archive/${row.slug}`}>
...
function detailLinkFormatter(cell, row){
    if (row.isArchived === true) {
        ...
        return (
            <Link to={`/admin/staff/${row.user}/community/score-point/archive/${row.uuid}`}>
...
class AdminStaffScorePointListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/admin/staff/${slug}/community/add-score-point`} className="d-block link-ndecor" title="Staffs">
...
export default AdminStaffScorePointListComponent;
