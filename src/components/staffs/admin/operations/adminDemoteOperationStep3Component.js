...
export default class AdminStaffDemoteOperationStep3Component extends Component {
    render() {
        const { staff, errors, slug, onClick, isLoading } = this.props;
                ...
                <div className="row pt-3 mb-4 pb-2">
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <div className="jumbotron">
                            ...
                            <p className="lead">This will demote our staff.</p>
                            <hr />
                            <p>Please click <strong>save</strong> to proceed.</p>
                            <p>
                            <Link to={`/admin/staff/${slug}/demote/step-2`} className="btn btn-orange btn-lg  float-left">
