...
class AdminStaffCreateStep1Component extends Component {
            ...
            <div>
                ...
                <div id="m-search" className="col-sm-5 mx-auto mt-4 pt-4">
                    ...
                    <div className="jumbotron">
                        ...
                        <p className="lead">To create a <strong>staff member</strong>, you will need to promote <strong>any user</strong> from our users list. Please enter the search field.</p>
                    </div>
...
export default AdminStaffCreateStep1Component;
