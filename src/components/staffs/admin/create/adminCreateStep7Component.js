...
export default class AdminStaffCreateStep7Component extends Component {
    render() {
        const {
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-6" className="st-grey">
                            <Link to="/admin/staffs/add/step-6">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/staffs/add/step-6" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
