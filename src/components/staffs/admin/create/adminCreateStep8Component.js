...
export default class AdminStaffCreateStep8Component extends Component {
                ...
                <div className="row pt-3 mb-4 pb-2">
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <div className="jumbotron">
                            ...
                            <p className="lead">This will add a new staff.</p>
                            <hr />
                            <p>Please click <strong>save</strong> to proceed.</p>
                            <p>
                            <Link to="/admin/staffs/add/step-7" className="btn btn-orange btn-lg  float-left">
