...
class TaskRetrieveComponent extends Component {
    render() {
        ...
        return (
            <div>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-tasks"></i>&nbsp;Argyle
                        </li>
                    </ol>
                </nav>
                ...
                <h1><i className="fas fa-tasks"></i>&nbsp;Argyle</h1>
...
export default TaskRetrieveComponent;
