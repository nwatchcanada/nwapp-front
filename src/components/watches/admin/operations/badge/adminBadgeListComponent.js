...
function detailLinkFormatter(cell, row){
    if (row.isArchived === true) {
        ...
        return (
            <Link to={`/admin/watch/${row.user}/community/badge/archive/${row.uuid}`}>
...
class AdminWatchBadgeListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/admin/watch/${slug}/community/add-badge`} className="d-block link-ndecor" title="Watches">
...
export default AdminWatchBadgeListComponent;
