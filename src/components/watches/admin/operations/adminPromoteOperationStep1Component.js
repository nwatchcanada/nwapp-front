...
export default class AdminWatchPromoteOperationStep1Component extends Component {
    render() {
        const { slug, watch, onClick, isLoading } = this.props;
        console.log(watch);
        return (
            <main id="main" role="main">
                ...
                <h1><i className="fas fa-star"></i>&nbsp;Promote Watch</h1>
                    ...
                    <div className="col-sm-3">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Promote the watch to be an <strong>area coordinator</strong>.</p>
                    ...
                    <div className="col-sm-3">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Promote the watch to be an <strong>associate</strong>.</p>
                    ...
                    <div className="col-sm-3">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Promote the watch to be <strong>staff</strong>.</p>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <Link to={`/admin/watch/${slug}/operations`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
