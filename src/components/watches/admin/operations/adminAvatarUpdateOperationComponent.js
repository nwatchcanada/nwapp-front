...
export default class AdminWatchAvatarUpdateOperationComponent extends Component {
    render() {
        const {
            file, isLoading, slug, watch, errors, onClick, onFileDrop, onRemoveFileUploadClick
        } = this.props;
        return (
            <div>
