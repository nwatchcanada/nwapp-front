...
export default class AdminWatchPromoteOperationStep2Component extends Component {
    render() {
        const {
            slug, watch, onClick, isLoading, errors, onPoliceCheckDateChange, onCheckboxChange,
                    ...
                    <div className="step-navigation">
                        <div id="step-1" className="st-grey">
                            <span className="num">1.</span><span className="">
                                <Link to={`/admin/watch/${slug}/promote/step-1`}>Selection</Link>
                            </span>
                        </div>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/watch/${slug}/promote/step-1`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
