...
function detailLinkFormatter(cell, row){
    if (row.isArchived === true) {
        ...
        return (
            <Link to={`/admin/watch/${row.user}/community/award/archive/${row.uuid}`}>
...
class AdminWatchAwardListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
...
export default AdminWatchAwardListComponent;
