            ...
            <main id="main" role="main">
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            <h1><i className="fas fa-archive"></i>&nbsp;Archive Watch</h1>
                            <p>You are about to <strong>archive the watch</strong> this means the watch will be in a read-only state and the watch cannot create work orders for our associates. Please explain why. All fields which have the (*) symbol are required to be filled out.</p>
                            ...
                            <BootstrapSingleSelect
                                ...
                                options={WATCH_ARCHIVE_REASON_CHOICES}
                                value={reason}
                                error={errors.reason}
