    ...
    render() {
        ...
        return (
            <main id="main" role="main">
                ...
                <h2>
                    <i className="fas fa-sitemap"></i>&nbsp;Select Watch Type
                </h2>
                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Add a residential or community cares watch</p>
                ...
                <div className="form-group">
                    ...
                    <Link to="/admin/watches/add/step-2" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
