...
export default class AdminWatchCreateStep7Component extends Component {
    render() {
        const {
        ...
        try {
            showHouseholdCount = parseInt(anotherHouseholdWatchRegistered) === 0;
        } catch (error) {
            // Do nothing.
        }
        ...
        return (
            <main id="main" role="main">
                ...
                <h1>
                    <i className="fas fa-plus"></i>&nbsp;Add Watch
                </h1>
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-2" className="st-grey">
                            <Link to="/admin/watches/add/step-2">
                        ...
                        <div id="step-4" className="st-grey">
                            <Link to="/admin/watches/add/step-4">
                                <span className="num">4.</span><span className="">Contact</span>
                            </Link>
                        </div>
                        <div id="step-5" className="st-grey">
                            <Link to="/admin/watches/add/step-5">
                                <span className="num">5.</span><span className="">Address</span>
                            </Link>
                        </div>
                        <div id="step-6" className="st-grey">
                            <Link to="/admin/watches/add/step-6">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/watches/add/step-6" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
