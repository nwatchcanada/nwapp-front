...
class AdminWatchCreateStep4Component extends Component {
    render() {
        const {
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/watches/add/step-3" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default AdminWatchCreateStep4Component;
