...
export default class AdminWatchCreateStep6Component extends Component {
    render() {
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <p>According to the address you entered, you are eligable for the following watches, please select the watch which is appropriate for the watch:</p>
                            ...
                            <div className="form-group">
                                <Link to="/admin/watches/add/step-5" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
