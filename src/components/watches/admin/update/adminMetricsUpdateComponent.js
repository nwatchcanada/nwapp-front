...
export default class AdminWatchMetricUpdateComponent extends Component {
    render() {
        const {
            slug, watch, typeOf, isTagsLoading, tags, tagOptions, yearOfBirth, gender, isHowHearLoading, howDidYouHear, howDidYouHearOptions, howDidYouHearOther,
            isMeaningLoading, meaning, meaningOptions, meaningOther, isExpectationLoading, expectation, expectationOptions, expectationOther, willingToVolunteer, anotherHouseholdWatchRegistered, totalHouseholdCount, under18YearsHouseholdCount,
            ...
            <main id="main" role="main">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to={`/admin/watch/${slug}/full`}><i className="fas fa-user"></i>&nbsp;{watch && watch.fullName}</Link>
                        </li>
                ...
                <h1>
                    <i className="fas fa-edit"></i>&nbsp;Update Watch (Metrics)
                </h1>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapRadio
                                inputClassName="form-check-input form-check-input-lg"
                                borderColour="border-primary"
                                error={errors.anotherHouseholdWatchRegistered}
                                label="Is there another watch of your household which is registered with us? (*)"
                                name="anotherHouseholdWatchRegistered"
                                onChange={onRadioChange}
                                selectedValue={anotherHouseholdWatchRegistered}
                                options={ANOTHER_HOUSEHOLD_MEMBER_REGISTERED_CHOICES}
                            />

                            {anotherHouseholdWatchRegistered === 0 &&
                                <div>
                                    <BootstrapInput
                                        inputClassName="form-control form-control-lg"
                                        borderColour="border-primary"
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/watch/${slug}/full`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
