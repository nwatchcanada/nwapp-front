...
export default class AdminWatchFileUploadAddComponent extends Component {
    render() {
        const {
            ...
            flashMessage, isLoading, slug, watch, onTextChange, onMultiChange, errors, onClick,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/watch/${slug}/files`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
