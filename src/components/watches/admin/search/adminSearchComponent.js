...
class AdminWatchSearchComponent extends Component {
            ...
            <div>
                ...
                <div id="m-search" className="col-sm-5 mx-auto mt-4 pt-4">
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        <div className="col-md-12 text-center">
                            <Link to="/admin/watches" className="btn btn-orange btn-lg mt-4 pl-4 pr-4">
...
export default AdminWatchSearchComponent;
