...
export default class WatchCreateStep4BizComponent extends Component {
    render() {
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-2" className="st-grey">
                            <Link to="/watches/step-2-create-biz">
                                <span className="num">2.</span><span className="">Details</span>
                            </Link>
                        </div>
                        <div id="step-3" className="st-grey">
                            <Link to="/watches/step-3-create-biz">
                    ...
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to="/watches/step-3-create-biz" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
