...
export default class AdminAreaCoordinatorOperationsComponent extends Component {
    render() {
        const { slug, areaCoordinator, user, errors, flashMessage, isLoading, onAddJobClick } = this.props;
        const isActiveState = areaCoordinator.state === "active";
        return (
                        ...
                        <div className="card-group row">
                            ...
                            <div className="col-sm-3 mb-4">
                                <div className="card box-shadow text-center mx-auto h-100">
                                    ...
                                    <div className="card-body">
                                        <h3 className="card-title">Permanently Delete AreaCoordinator</h3>
                                        <p className="card-text">Delete data from the database.</p>
                                    </div>
                                    <div className="card-footer bg-transparent border-0">
                                        <Link to={`/areaCoordinator/${slug}/delete`} className="btn btn-success btn-lg">
                                            Go&nbsp;<i className="fas fa-chevron-right"></i>
                                        </Link>
                                    </div>
                                </div>
