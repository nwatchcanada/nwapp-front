...
export default class AdminAreaCoordinatorFileUploadAddComponent extends Component {
    render() {
        const {
            title, description, tags, tagOptions, isTagSetsLoading, file, isArchived,
            flashMessage, isLoading, slug, areaCoordinator, onTextChange, onMultiChange, errors, onClick,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/areaCoordinator/${slug}/files`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
