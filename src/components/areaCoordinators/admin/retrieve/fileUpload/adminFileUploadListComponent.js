...
class AdminAreaCoordinatorFileUploadListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
            ...
            // Data
            areaCoordinatorFiles, areaCoordinator, slug,
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/admin/area-coordinator/${slug}/file/add`} className="d-block link-ndecor" title="AreaCoordinators">
...
export default AdminAreaCoordinatorFileUploadListComponent;
