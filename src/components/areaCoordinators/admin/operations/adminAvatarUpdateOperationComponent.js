...
export default class AdminAreaCoordinatorAvatarUpdateOperationComponent extends Component {
    render() {
        const {
            file, isLoading, slug, areaCoordinator, errors, onClick, onFileDrop, onRemoveFileUploadClick
        } = this.props;
        return (
            <div>
