...
export default class AdminAreaCoordinatorUnarchiveOperationComponent extends Component {
    render() {
        // Common
        const { comment, slug, errors, onTextChange, onSelectChange, isLoading, onClick, areaCoordinator } = this.props;
        return (
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/areaCoordinator/${slug}/operations`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
