...
export default class AdminAreaCoordinatorDemoteOperationStep1Component extends Component {
    render() {
            ...
            <main id="main" role="main">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to="/admin/area-coordinators"><i className="fas fa-crown"></i>&nbsp;AreaCoordinators</Link>
                        </li>
                        <li className="breadcrumb-item" aria-current="page">
                    ...
                    <div className="col-sm-12">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Demote the area coordinator to be a <strong>member</strong>.</p>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <Link to={`/admin/area-coordinator/${slug}/operations`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
