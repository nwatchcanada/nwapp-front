...
export default class AdminAreaCoordinatorDemoteOperationStep2Component extends Component {
    render() {
        const {
            slug, onClick, isLoading, errors,
            onTextChange, onPoliceCheckDateChange, onCheckboxChange, onSelectChange,
            reason, reasonOptions, reasonOther, areaCoordinator,
            roleId,
        ...
        const isAreaCoordinator = roleId === FRONTLINE_STAFF_ROLE_ID || roleId === MANAGEMENT_ROLE_ID;
        return (
                ...
                <div className="row">
                    <div className="step-navigation">
                        <div id="step-1" className="st-grey">
                            <Link to={`/admin/area-coordinator/${slug}/demote/step-1`}>
                        ...
                        <div className="form-group">
                            ...
                            {roleId === ASSOCIATE_ROLE_ID &&
                                <BootstrapCheckbox
                                    ...
                                    borderColour="border-success"
                                    error={errors.areaCoordinatorAgreement}
                                    label="I agree to the AreaCoordinator agreement. (*)"
                                    onChange={onCheckboxChange}
                                    value={areaCoordinatorAgreement}
                                    name="areaCoordinatorAgreement"
                                />
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/area-coordinator/${slug}/demote/step-1`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
