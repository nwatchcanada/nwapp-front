...
export default class AdminAreaCoordinatorScorePointArchiveComponent extends Component {
    render() {
        const {
            isLoading, slug, areaCoordinator, errors, onClick
        } = this.props;
        return (
            <div>
                ...
                <div className="row" id="mainNav">
                    <div className="step-navigation">
                        ...
                        <div id="step-3" className="st-grey">
                            <Link to={`/areaCoordinator/${slug}/orders`}>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="jumbotron">
                                ...
                                <p className="lead">You are about to archive the file, this file will no longer be available to the staff and the areaCoordinator.</p>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/area-coordinator/${slug}/community/score-points`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
