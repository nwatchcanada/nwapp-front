...
export default class AdminAreaCoordinatorScorePointAddComponent extends Component {
    render() {
        const {
            typeOf, typeOfOther, onSelectChange, descriptionOther, amount, tags, tagOptions, isTagSetsLoading, file, isArchived,
            flashMessage, isLoading, slug, areaCoordinator, onTextChange, onMultiChange, errors, onSubmitClick
        } = this.props;
        return (
            <div>
