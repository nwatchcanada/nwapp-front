            ...
            <main id="main" role="main">
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            <h3>Search for existing areaCoordinator:</h3>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/areaCoordinators" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
                ...
                <div className="col-md-12 text-center">
                    ...
                    <a href="/admin/areaCoordinators/add/step-3" role="button" className="btn btn-success btn-lg">
                        Add New AreaCoordinator&nbsp;<i class="fas fa-chevron-right"></i>
                    </a>
                </div>
            </main>
        );
