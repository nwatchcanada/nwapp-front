...
export default class AdminAreaCoordinatorCreateStep7Component extends Component {
    render() {
        const {
        ...
        try {
            showHouseholdCount = parseInt(anotherHouseholdAreaCoordinatorRegistered) === 0;
        } catch (error) {
            // Do nothing.
        }
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-6" className="st-grey">
                            <Link to="/admin/areaCoordinators/add/step-6">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/areaCoordinators/add/step-6" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
