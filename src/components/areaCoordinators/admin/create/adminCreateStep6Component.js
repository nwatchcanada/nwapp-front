...
export default class AdminAreaCoordinatorCreateStep6Component extends Component {
    render() {
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-4" className="st-grey">
                            <Link to="/admin/areaCoordinators/add/step-4">
                                <span className="num">4.</span><span className="">Contact</span>
                            </Link>
                        </div>
                        <div id="step-5" className="st-grey">
                            <Link to="/admin/areaCoordinators/add/step-5">
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <p>According to the address you entered, you are eligable for the following watches, please select the watch which is appropriate for the areaCoordinator:</p>
                            ...
                            <div className="form-group">
                                <Link to="/admin/areaCoordinators/add/step-5" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
