...
class AdminAreaCoordinatorAdressUpdateComponent extends Component {
    render() {
        const {
            ...
            returnURL, errors, onTextChange, onSelectChange, isLoading, onClick, slug
        } = this.props;
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to="/area-coordinators"><i className="fas fa-users"></i>&nbsp;AreaCoordinators</Link>
                        </li>
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to={`/area-coordinator/${slug}/full`}><i className="fas fa-users"></i>&nbsp;AreaCoordinator</Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-edit"></i>&nbsp;Edit AreaCoordinator
                        </li>
                    </ol>
                </nav>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/area-coordinator/${slug}/full`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default AdminAreaCoordinatorAdressUpdateComponent;
