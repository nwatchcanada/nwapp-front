...
function externalLinkFormatter(cell, row){
    return (
        <a target="_blank" href={`/area-coordinators/${row.slug}`}>
...
export default class AreaCoordinatorSearchResultComponent extends Component {
    render() {
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                           <Link to={`/area-coordinators/search`}><i className="fas fa-search"></i>&nbsp;Search</Link>
                        </li>
                ...
                <div className="form-group">
                    <Link to="/area-coordinators/search" className="btn btn-secondary btn-lg">
