...
class AssociateActiveListComponent extends Component {
    render() {
        ...
        return (
            <div>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-id-card"></i>&nbsp;Associates
                        </li>
                    </ol>
                </nav>
                ...
                <h1><i className="fas fa-id-card"></i>&nbsp;Associates</h1>
                        ...
                        <section className="row text-center placeholders">
                            ...
                            <div className="col-sm-6 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-dgreen">
                                    <Link to="/associates/active/search" className="d-block link-ndecor" title="Search">
...
export default AssociateActiveListComponent;
