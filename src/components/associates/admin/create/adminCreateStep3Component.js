        ...
        return (
            <main id="main" role="main">
                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Add a residential or community cares associate</p>
                ...
                <div className="form-group">
                    ...
                    <Link to="/admin/associates/add/step-2" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
