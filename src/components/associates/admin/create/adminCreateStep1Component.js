        ...
        return (
            <main id="main" role="main">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/associates" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
                ...
                <div className="col-md-12 text-center">
                    ...
                    <a href="/admin/associates/add/step-3" role="button" className="btn btn-success btn-lg">
                        Add New Associate&nbsp;<i class="fas fa-chevron-right"></i>
                    </a>
                </div>
            </main>
        );
