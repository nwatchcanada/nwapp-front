...
export default class AdminAssociateMetricUpdateComponent extends Component {
    render() {
        const {
        ...
        return (
            <main id="main" role="main">
                ...
                <h1>
                    <i className="fas fa-edit"></i>&nbsp;Update Associate (Metrics)
                </h1>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/admin/associate/${slug}/full`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
