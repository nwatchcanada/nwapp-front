...
export default class AdminAssociatePromoteOperationStep2Component extends Component {
    render() {
        const { roleId, associate, policeCheckDate, errors, slug, onClick, isLoading } = this.props;
            ...
            <main id="main" role="main">
                    ...
                    <div className="step-navigation">
                        ...
                        <div id="step-2" className="st-grey">
                            <span className="num">2.</span><span className="">
                                <Link to={`/admin/associate/${slug}/promote/step-2`}>Agreement</Link>
                            </span>
                        </div>
                ...
                <div className="row pt-3 mb-4 pb-2">
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <p><strong>Please confirm these details before promoting the associate:</strong></p>
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to={`/admin/associate/${slug}/promote/step-2`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
