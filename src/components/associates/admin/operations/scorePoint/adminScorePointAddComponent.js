...
export default class AdminAssociateScorePointAddComponent extends Component {
    render() {
        const {
            typeOf, typeOfOther, onSelectChange, descriptionOther, amount, tags, tagOptions, isTagSetsLoading, file, isArchived,
            flashMessage, isLoading, slug, associate, onTextChange, onMultiChange, errors, onSubmitClick
        } = this.props;
        return (
            <div>
