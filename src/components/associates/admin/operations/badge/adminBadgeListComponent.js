...
function detailLinkFormatter(cell, row){
    if (row.isArchived === true) {
        ...
        return (
            <Link to={`/admin/associate/${row.user}/community/badge/archive/${row.uuid}`}>
...
class AdminAssociateBadgeListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/admin/associate/${slug}/community/add-badge`} className="d-block link-ndecor" title="Associates">
...
export default AdminAssociateBadgeListComponent;
