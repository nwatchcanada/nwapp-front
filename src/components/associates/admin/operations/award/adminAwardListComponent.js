...
function detailLinkFormatter(cell, row){
    if (row.isArchived === true) {
        ...
        return (
            <Link to={`/admin/associate/${row.user}/community/award/archive/${row.uuid}`}>
...
class AdminAssociateAwardListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
...
export default AdminAssociateAwardListComponent;
