...
export default class StaffCommentComponent extends Component {
    render() {
        const {
            staffComments, flashMessage, isLoading, slug, staff, text, onTextChange, errors, onClick
        } = this.props;
        return (
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to="/staffs"><i className="fas fa-user-circle"></i>&nbsp;Staffs</Link>
                        </li>
                ...
                <div className="row align-items-start">
                    ...
                    <div className="col-lg-12">
                        {staffComments && staffComments.map(
