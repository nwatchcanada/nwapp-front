...
import ConcernItemFilterComponent from "./concernItemFilterComponent";


class ConcernItemListComponent extends Component {
    render() {
    ...
    render() {
        ...
        return (
            <div>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-exclamation-circle"></i>&nbsp;Concern Items
                        </li>
                    </ol>
                </nav>
                ...
                <h1><i className="fas fa-exclamation-circle"></i>&nbsp;Concern Items</h1>
                ...
                */ }
                ...
                <ConcernItemFilterComponent filter={filter} onFilterClick={onFilterClick} />

                {isActive &&
                    <ConcernItemListComponent items={items} />
                }
                {isInactive &&
