    ...
    render() {
        ...
        return (
            <div>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-id-card"></i>&nbsp;Report
                        </li>
                    </ol>
                </nav>
                ...
                <h1><i className="fas fa-id-card"></i>&nbsp;Report</h1>
                <div className="row">
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-3 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to="/report/add" className="d-block link-ndecor" title="Clients">
                                        <span className="r-circle"><i className="fas fa-plus fa-3x"></i></span>
                                    </Link>
                                </div>
                                <h4>Add</h4>
                                <div className="text-muted">Add a report</div>
                            </div>
                            { /*
                            <div className="col-sm-3 placeholder">
                                ...
                                <h4>Search</h4>
                                <span className="text-muted">Search your reports</span>
                            </div>

                            <div className="col-sm-3 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-dblue">
                                    <Link to="#" className="d-block link-ndecor" title="Report">
                                        <h1 className="circle-title">2,200</h1>
                                    </Link>
                                </div>
                                <h4>Associate Report</h4>
                                <span className="text-muted">View Report Data</span>
                            </div>
                            <div className="col-sm-3 placeholder">
