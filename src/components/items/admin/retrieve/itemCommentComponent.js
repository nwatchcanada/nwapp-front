...
export default class ItemCommentComponent extends Component {
    render() {
        const {
            itemComments, flashMessage, isLoading, slug, item, text, onTextChange, errors, onClick
        } = this.props;
        return (
            <div>
