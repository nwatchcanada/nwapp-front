...
class ItemPhotosUpdateComponent extends Component {
    render() {
        const {
            category,
            categoryOptions,
            ...
            <main id="main" role="main">
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-3" className="st-grey">
                            <span className="num">3.</span><span className="">Photos</span>
                        </div>
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            <h1><i className="fas fa-sign"></i>&nbsp;Photos Form</h1>
...
export default ItemPhotosUpdateComponent;
