...
import { OTHER_VOLUNTEER_TYPE_OF } from "../../../../../constants/api";


class ItemCreateStep2VolunteerComponent extends Component {
    render() {
        const {
            category,
            categoryOptions,
        ...
        const isOtherVolunteerTypeOf = category === OTHER_VOLUNTEER_TYPE_OF;
        return (
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapSingleSelect
                                ...
                                name="category"
                                defaultOptionLabel="Please select the volunteer category."
                            ...
                            {isOtherVolunteerTypeOf &&
                                <BootstrapInput
                                    inputClassName="form-control form-control-lg"
                                    borderColour="border-primary"
                                    error={errors.categoryOther}
                                    label="Volunteer Category - Other (*)"
...
export default ItemCreateStep2VolunteerComponent;
