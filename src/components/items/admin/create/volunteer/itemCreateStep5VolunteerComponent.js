...
class ItemCreateStep5VolunteerComponent extends Component {
    render() {
        const {
            externalURL,
            onTextChange,
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-2" className="st-grey">
                            <Link to="/admin/item/add/step-2-volunteer">
                                <span className="num">2.</span><span className="">Categorize</span>
                            </Link>
                        </div>
                        <div id="step-3" className="st-grey">
                            <Link to="/admin/item/add/step-3-volunteer">
                                <span className="num">3.</span><span className="">Who</span>
                            </Link>
                        </div>
                        <div id="step-4" className="st-grey">
                            <Link to="/admin/item/add/step-4-volunteer">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapInput
                                ...
                                name="externalURL"
                                type="text"
                                helpText="If you would like people to visit an external website for this volunteer post, please fill it in here."
                            />
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/item/add/step-4-volunteer" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default ItemCreateStep5VolunteerComponent;
