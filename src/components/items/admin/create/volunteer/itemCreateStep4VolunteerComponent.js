...
class ItemCreateStep4VolunteerComponent extends Component {
    render() {
        const {
            description,
            onTextChange,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/item/add/step-3-volunteer" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default ItemCreateStep4VolunteerComponent;
