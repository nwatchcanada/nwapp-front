...
import { OTHER_RESOURCE_TYPE_OF } from "../../../../../constants/api";


class ItemCreateStep2ResourceComponent extends Component {
    render() {
        const {
            category,
            categoryOptions,
        ...
        const isOtherResourceTypeOf = category === OTHER_RESOURCE_TYPE_OF;
        return (
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapSingleSelect
                                ...
                                name="category"
                                defaultOptionLabel="Please select the resource category."
                            ...
                            {isOtherResourceTypeOf &&
                                <BootstrapInput
                                    inputClassName="form-control form-control-lg"
                                    borderColour="border-primary"
                                    error={errors.categoryOther}
                                    label="Resource Category - Other (*)"
...
export default ItemCreateStep2ResourceComponent;
