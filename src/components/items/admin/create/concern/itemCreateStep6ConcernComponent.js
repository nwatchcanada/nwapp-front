...
export default class ItemCreateStep6ConcernComponent extends Component {
    render() {
                ...
                <div className="row pt-3 mb-4 pb-2">
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <div className="jumbotron">
                            ...
                            <p>
                            <Link to={`/admin/item/add/step-5-concern`} className="btn btn-orange btn-lg  float-left">
