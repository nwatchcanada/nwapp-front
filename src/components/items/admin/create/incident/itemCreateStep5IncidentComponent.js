...
class ItemCreateStep5IncidentComponent extends Component {
    render() {
        const {
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-4" className="st-grey">
                            <Link to="/admin/item/add/step-4-incident">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/item/add/step-4-incident" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default ItemCreateStep5IncidentComponent;
