...
class ItemCreateStep3InformationComponent extends Component {
    render() {
        ...
        return (
            <main id="main" role="main">
                ...
                <h1><i className="fas fa-plus"></i>&nbsp;Add Information Item</h1>
                ...
                <div className="row">
                    <div className="step-navigation">
                        ...
                        <div id="step-2" className="st-grey">
                            <Link to="/admin/item/add/step-2-information">
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/admin/item/add/step-2-information" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default ItemCreateStep3InformationComponent;
