...
export default class AssociateCommentComponent extends Component {
    render() {
        const {
        ...
        return (
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to="/associates"><i className="fas fa-user-crown"></i>&nbsp;Associates</Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-crown"></i>&nbsp;{associate && associate.fullName}
                        </li>
                    </ol>
                </nav>
                ...
                <h1><i className="fas fa-crown"></i>&nbsp;{associate && associate.fullName}</h1>
