...
export default class AdminItemTypeArchiveComponent extends Component {
    render() {
        const {
            isLoading, id, itemType, errors, onClick
        } = this.props;
        return (
            <div>
                ...
                {itemType.state === 'inactive' &&
                    <div className="alert alert-info" role="alert">
                        <strong><i className="fas fa-archive"></i>&nbsp;Archived</strong> - This itemType is archived and is read-only.
                    </div>
                }
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="jumbotron">
                                ...
                                <p className="lead">You are about to archive the file, this file will no longer be available to the staff and the itemType.</p>
                            </div>
