...
class AdminAnnouncementListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
        ...
        return (
            <div>
                ...
                <h1><i className="fas fa-bullhorn"></i>&nbsp;Announcement</h1>
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/admin/settings/announcement/add/step-1`} className="d-block link-ndecor" title="Members">
...
export default AdminAnnouncementListComponent;
