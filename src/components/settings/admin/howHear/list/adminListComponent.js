...
function fileFormatter(cell, row){
    return (
        <div>
            ...
            &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
            {row.isArchived === false &&
                <Link to={`/admin/settings/how-hear/${row.user}/file/archive/${row.id}`}>
...
class AdminHowHearListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/admin/settings/how-hear/add/step-1`} className="d-block link-ndecor" title="Members">
                                        <span className="r-circle"><i className="fas fa-plus fa-3x"></i></span>
                                    </Link>
                                </div>
                                <h4>Add How did you hear</h4>
                                <div className="text-muted">Add How did you hear</div>
                            </div>
                        </section>
                    </div>
                </div>
...
export default AdminHowHearListComponent;
