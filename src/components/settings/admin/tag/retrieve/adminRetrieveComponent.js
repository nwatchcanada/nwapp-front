...
export default class AdminTagRetrieveComponent extends Component {
    render() {
        const { tagData, onClick, onBack, flashMessage, isLoading } = this.props;
        return (
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to="/admin/settings/tags"><i className="fas fa-tags"></i>&nbsp;Tags</Link>
                        </li>
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-tag"></i>&nbsp;{tagData && tagData.text}
                        </li>
                    </ol>
                </nav>
                        ...
                        <table className="table table-bordered custom-cell-w">
                            <tbody>
                                <tr className="bg-dark">
                                    <th scope="row" colSpan="2" className="text-light"><i className="fas fa-table"></i>&nbsp;Tag details</th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {tagData && <Moment format="MM/DD/YYYY hh:mm:ss a">{tagData.created}</Moment>}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {tagData && <Moment format="MM/DD/YYYY hh:mm:ss a">{tagData.lastModified}</Moment>}
                                    </td>
                                </tr>
                                <tr>
