...
class AdminDistrictCreateStep3Container extends Component {
    render() {
        const {
            errors, isLoading, onClick, step2URL
        } = this.props;
        return (
                ...
                <div className="row pt-3 mb-4 pb-2">
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <div className="jumbotron">
                            ...
                            <p>
                            <Link to={step2URL} className="btn btn-orange btn-lg  float-left">
...
export default AdminDistrictCreateStep3Container;
