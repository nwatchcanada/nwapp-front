    ...
    render() {
        ...
        return (
            <tr slug={slug}>
                ...
                <td>{name}</td>
                <td>
                    <Link to={`/settings/how-hear/${slug}/update`} className="btn btn-primary pl-4 pr-4">
                        <i className="fas fa-edit"></i>&nbsp;Edit
                    </Link>&nbsp;&nbsp;&nbsp;
                    <Link to={`/settings/how-hear/${slug}/delete`} className="btn btn-danger pl-4 pr-4">
...
class HowHearsListComponent extends Component {
    render() {
                    ...
                    <div className="col-md-12">
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-3 placeholder">
                                ...
                                <h4>Add</h4>
                                <div className="text-muted">Add a howHear</div>
                            </div>
                            { /*
                            <div className="col-sm-3 placeholder">
                                ...
                                <h4>Search</h4>
                                <span className="text-muted">Search your howHears</span>
                            </div>
...
export default HowHearsListComponent;
