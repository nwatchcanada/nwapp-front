                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-3 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to="/setting/add" className="d-block link-ndecor" title="Clients">
                                        <span className="r-circle"><i className="fas fa-plus fa-3x"></i></span>
                                    </Link>
                                </div>
                                <h4>Add</h4>
                                <div className="text-muted">Add a setting</div>
                            </div>
                            { /*
                            <div className="col-sm-3 placeholder">
                                ...
                                <h4>Search</h4>
                                <span className="text-muted">Search your settings</span>
                            </div>

                            <div className="col-sm-3 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-dblue">
                                    <Link to="#" className="d-block link-ndecor" title="Setting">
                                        <h1 className="circle-title">2,200</h1>
                                    </Link>
                                </div>
                                <h4>Associate Setting</h4>
                                <span className="text-muted">View Setting Data</span>
                            </div>
                            <div className="col-sm-3 placeholder">
