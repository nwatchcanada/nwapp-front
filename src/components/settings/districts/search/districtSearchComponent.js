...
class DistrictSearchComponent extends Component {
    render() {
            ...
            <div>
                ...
                <div id="m-search" className="col-sm-5 mx-auto mt-4 pt-4">
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        <div className="col-md-12 text-center">
                            <Link to="/settings/districts" className="btn btn-secondary btn-lg mt-4 pl-4 pr-4">
...
export default DistrictSearchComponent;
