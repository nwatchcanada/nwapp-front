...
import ActionIncidentItemTaskStep3Component from "../../../components/tasks/actionIncidentItem/actionIncidentItemTaskStep3Component";
...
class ActionIncidentItemTaskStep3Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ActionIncidentItemTaskStep3Container);
