...
import ActionIncidentTaskStep4Component from "../../../../../components/taskItems/admin/operations/actionIncident/step4Component";
import {
...
class ActionIncidentTaskStep4Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <ActionIncidentTaskStep4Component
                errors={errors}
                isLoading={isLoading}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ActionIncidentTaskStep4Container);
