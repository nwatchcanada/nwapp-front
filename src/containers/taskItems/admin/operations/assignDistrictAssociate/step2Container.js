...
import AssignDistrictAssociateTaskStep2Component from "../../../../../components/taskItems/admin/operations/assignDistrictAssociate/step2Component";
...
class AssignDistrictAssociateTaskStep2Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        return (
            <AssignDistrictAssociateTaskStep2Component
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssignDistrictAssociateTaskStep2Container);
