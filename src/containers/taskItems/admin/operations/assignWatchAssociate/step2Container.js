...
import AssignWatchAssociateTaskStep2Component from "../../../../../components/taskItems/admin/operations/assignWatchAssociate/step2Component";
...
class AssignWatchAssociateTaskStep2Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
		...
		if (e.keyCode === 13) {
			this.setState({ advancedSearchActive: false, }, ()=> {
				...
				if (isValid) {
                    ...
                    this.props.history.push("/admin/task/2/"+this.state.uuid+"/step-3");
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssignWatchAssociateTaskStep2Container);
