...
import AssignWatchAssociateTaskStep4Component from "../../../../../components/taskItems/admin/operations/assignWatchAssociate/step4Component";
import {
...
class AssignWatchAssociateTaskStep4Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssignWatchAssociateTaskStep4Component
                errors={errors}
                isLoading={isLoading}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssignWatchAssociateTaskStep4Container);
