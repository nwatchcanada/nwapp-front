...
import AssignWatchAssociateTaskStep3Component from "../../../../../components/taskItems/admin/operations/assignWatchAssociate/step3Component";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
    ...
    onAssociateClick(e, associateSlug) {
        this.setState(
            ...
            ()=>{
                ...
                this.props.history.push("/admin/task/2/"+this.state.uuid+"/step-4");
            }
        );
    }
