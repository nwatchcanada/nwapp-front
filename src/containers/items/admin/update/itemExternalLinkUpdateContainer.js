...
import ItemExternalLinkUpdateComponent from "../../../../components/items/admin/update/itemExternalLinkUpdateComponent";
...
class ItemExternalLinkUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <ItemExternalLinkUpdateComponent
                category={category}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ItemExternalLinkUpdateContainer);
