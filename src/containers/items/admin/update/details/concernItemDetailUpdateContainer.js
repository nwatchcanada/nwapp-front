...
import ConcernItemDetailUpdateComponent from "../../../../../components/items/admin/update/details/concernItemDetailUpdateComponent";
...
class ConcernItemDetailUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            title: item.title,                                       // Concern
            description: item.description,                           // Concern
            location: item.location,                                 // Concern
        }
    ...
    render() {
        ...
        if (typeOf === CONCERN_ITEM_TYPE_OF) {
            return (
                <ConcernItemDetailUpdateComponent
                    slug={slug}
                    errors={errors}
                    typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ConcernItemDetailUpdateContainer);
