...
import InformationItemDetailUpdateComponent from "../../../../../components/items/admin/update/details/informationItemDetailUpdateComponent";
...
class InformationItemDetailUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <InformationItemDetailUpdateComponent
                slug={slug}
                errors={errors}
                typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(InformationItemDetailUpdateContainer);
