...
import CommunityNewsItemDetailUpdateComponent from "../../../../../components/items/admin/update/details/communityNewsItemDetailUpdateComponent";
...
class CommunityNewsItemDetailUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            description: item.description,                           // CommunityNews | Event |
    ...
    render() {
        ...
        return (
            <CommunityNewsItemDetailUpdateComponent
                slug={slug}
                errors={errors}
                typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(CommunityNewsItemDetailUpdateContainer);
