...
import IncidentItemDetailUpdateComponent from "../../../../../components/items/admin/update/details/incidentItemDetailUpdateComponent";
...
class IncidentItemDetailUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        if (typeOf === INCIDENT_ITEM_TYPE_OF) {
            return (
                <IncidentItemDetailUpdateComponent
                    slug={slug}
                    errors={errors}
                    typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(IncidentItemDetailUpdateContainer);
