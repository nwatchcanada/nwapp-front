...
import ItemCreateStep4VolunteerComponent from "../../../../../components/items/admin/create/volunteer/itemCreateStep4VolunteerComponent";
...
import { validateVolunteerStep4Input } from "../../../../../validators/itemValidator";


class ItemCreateStep4VolunteerContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        const { errors, isValid } = validateVolunteerStep4Input(this.state);

        // CASE 1 OF 2: Validation passed successfully.
        if (isValid) {
            this.setState({ errors: {}, isLoading: true, })
            this.props.history.push("/admin/item/add/step-5-volunteer");
    ...
    render() {
        ...
        return (
            <ItemCreateStep4VolunteerComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ItemCreateStep4VolunteerContainer);
