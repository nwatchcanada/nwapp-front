...
import ItemCreateStep7VolunteerComponent from "../../../../../components/items/admin/create/volunteer/itemCreateStep7VolunteerComponent";
import {
...
class ItemCreateStep7VolunteerContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessfulSubmissionCallback(item) {
        ...
        localStorageRemoveItemsContaining("nwapp-item-create-volunteer-");
    ...
    render() {
        ...
        return (
            <ItemCreateStep7VolunteerComponent
                // Step 1
                typeOf={typeOf}

                // Step 2
                prettyVolunteerTypeOf={prettyVolunteerTypeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ItemCreateStep7VolunteerContainer);
