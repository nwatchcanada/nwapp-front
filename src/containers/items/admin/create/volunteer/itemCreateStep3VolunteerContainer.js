...
import ItemCreateStep3VolunteerComponent from "../../../../../components/items/admin/create/volunteer/itemCreateStep3VolunteerComponent";
...
import { validateVolunteerStep3Input } from "../../../../../validators/itemValidator";


class ItemCreateStep3VolunteerContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onRadioChange(e) {
        // Get the values.
        const storageValueKey = "nwapp-item-create-volunteer-"+[e.target.name];
        const storageLabelKey =  "nwapp-item-create-volunteer-"+[e.target.name].toString()+"-label";
    ...
    onClick(e) {
        ...
        const { errors, isValid } = validateVolunteerStep3Input(this.state);

        // CASE 1 OF 2: Validation passed successfully.
        if (isValid) {
            this.setState({ errors: {}, isLoading: true, })
            this.props.history.push("/admin/item/add/step-4-volunteer");
    ...
    render() {
        ...
        return (
            <ItemCreateStep3VolunteerComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ItemCreateStep3VolunteerContainer);
