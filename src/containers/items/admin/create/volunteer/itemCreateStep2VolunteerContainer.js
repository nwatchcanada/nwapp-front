...
import ItemCreateStep2VolunteerComponent from "../../../../../components/items/admin/create/volunteer/itemCreateStep2VolunteerComponent";
...
import { validateVolunteerStep2Input } from "../../../../../validators/itemValidator";
import { OTHER_VOLUNTEER_TYPE_OF, VOLUNTEER_ITEM_TYPE_OF } from "../../../../../constants/api";
import { pullItemTypeList, getItemTypeReactSelectOptions } from "../../../../../actions/itemTypeActions";


class ItemCreateStep2VolunteerContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        parametersMap.set("category", VOLUNTEER_ITEM_TYPE_OF);
    ...
    onSuccessfulSubmissionCallback(item) {
        ...
        this.props.history.push("/admin/item/add/step-3-volunteer");
    }
    ...
    onSelectChange(option) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                localStorage.setItem('nwapp-item-create-volunteer-'+[option.selectName], option.value);
                localStorageSetObjectOrArrayItem('nwapp-item-create-volunteer-'+optionKey, option);
            }
        );
    }
    ...
    onClick(e) {
        ...
        const { errors, isValid } = validateVolunteerStep2Input(this.state);

        // CASE 1 OF 2: Validation passed successfully.
        if (isValid) {
            // Save for convinence the volunteer type depending on if the user
            // chose a standard option or the `other` option.
            if (this.state.category === OTHER_VOLUNTEER_TYPE_OF) {
                localStorage.setItem('nwapp-item-create-volunteer-pretty-volunteer-type', this.state.categoryOther);
            } else {
                localStorage.setItem('nwapp-item-create-volunteer-pretty-volunteer-type', this.state.categoryOption.label);
            }
    ...
    render() {
        ...
        return (
            <ItemCreateStep2VolunteerComponent
                category={category}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ItemCreateStep2VolunteerContainer);
