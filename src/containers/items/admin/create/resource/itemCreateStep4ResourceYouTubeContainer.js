...
class ItemCreateStep4ResourceYouTubeContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        if (isValid) {
            ...
            console.log("STATE:\n",this.state,"\n\n");
            localStorage.setItem("nwapp-item-create-resource-returnURL", "/admin/item/add/step-4-resource-youtube");
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ItemCreateStep4ResourceYouTubeContainer);
