...
class ItemCreateStep4ResourceFileContainer extends Component {
    ...
    onClick(e) {
        ...
        const { errors, isValid } = validateResourceStep4FileInput(this.state);

        // CASE 1 OF 2: Validation passed successfully.
        if (isValid) {
            this.setState({ errors: {}, isLoading: true, })
            console.log("STATE:\n",this.state,"\n\n");
            localStorage.setItem("nwapp-item-create-resource-returnURL", "/admin/item/add/step-4-resource-file");
