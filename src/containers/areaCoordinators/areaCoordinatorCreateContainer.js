...
import AreaCoordinatorCreateComponent from "../../components/areaCoordinators/areaCoordinatorCreateComponent";
import { setFlashMessage } from "../../actions/flashMessageActions";
import validateInput from "../../validators/areaCoordinatorValidator";


class AreaCoordinatorCreateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AreaCoordinatorCreateComponent
                name={name}
                errors={errors}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AreaCoordinatorCreateContainer);
