...
import AreaCoordinatorFullListComponent from "../../components/areaCoordinators/areaCoordinatorListInactiveComponent";
import { clearFlashMessage } from "../../actions/flashMessageActions";


class AreaCoordinatorListInactiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        const tableData = [{
            ...
            'absoluteUrl': '/area-coordinators/inactive/argyle'
        },{
            'slug': 'byron',
            'icon': 'home',
            'number': 2,
            ...
            'absoluteUrl': '/area-coordinators/inactive/byron'
        },{
            'slug': 'carling',
            'icon': 'briefcase',
            'number': 3,
            ...
            'absoluteUrl': '/area-coordinators/inactive/carling'
        }];
        return (
            <AreaCoordinatorFullListComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AreaCoordinatorListInactiveContainer);
