...
import AreaCoordinatorSearchResultComponent from "../../components/areaCoordinators/areaCoordinatorSearchResultComponent";
...
class AreaCoordinatorSearchResultContainer extends Component {
    ...
    render() {
        const tableData = [{
            ...
            'absoluteUrl': '/area-coordinators/all/argyle'
        },{
            'slug': 'byron',
            'icon': 'home',
            'number': 2,
            ...
            'absoluteUrl': '/area-coordinators/all/byron'
        },{
            'slug': 'carling',
            'icon': 'briefcase',
            'number': 3,
            ...
            'absoluteUrl': '/area-coordinators/all/carling'
        }];
        return (
