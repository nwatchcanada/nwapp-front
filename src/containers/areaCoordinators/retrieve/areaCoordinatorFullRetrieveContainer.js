...
import AreaCoordinatorFullRetrieveComponent from "../../../components/areaCoordinators/retrieve/areaCoordinatorFullRetrieveComponent";
...
class AreaCoordinatorFullRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (this.state.slug === 'argyle') {
            ...
            this.setState({
                areaCoordinatorData: {
                    ...
                    number: 1,
                    name: 'Byron',
                    absoluteUrl: '/areaCoordinator/byron',
            ...
            this.setState({
                areaCoordinatorData: {
                    ...
                    number: 1,
                    name: 'Carling',
                    absoluteUrl: '/areaCoordinator/carling',
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AreaCoordinatorFullRetrieveContainer);
