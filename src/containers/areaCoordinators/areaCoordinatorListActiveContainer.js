...
import AreaCoordinatorActiveListComponent from "../../components/areaCoordinators/areaCoordinatorListActiveComponent";
import { clearFlashMessage } from "../../actions/flashMessageActions";


class AreaCoordinatorListActiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AreaCoordinatorListActiveContainer);
