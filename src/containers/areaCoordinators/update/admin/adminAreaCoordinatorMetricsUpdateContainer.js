...
import AdminAreaCoordinatorMetricsUpdateComponent from "../../../../components/areaCoordinators/update/admin/adminAreaCoordinatorMetricsUpdateComponent";
...
class AdminAreaCoordinatorMetricsUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorMetricsUpdateComponent
                typeOf={typeOf}
                returnURL={returnURL}
                tags={tags}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorMetricsUpdateContainer);
