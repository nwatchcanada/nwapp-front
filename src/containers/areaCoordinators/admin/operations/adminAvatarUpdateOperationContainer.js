...
class AdminAreaCoordinatorAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postAreaCoordinatorAvatarCreateOrUpdateOperation(
                this.getPostData(),
    ...
    render() {
        ...
        return (
            <AreaCoordinatorAvatarUpdateOperationComponent
                slug={slug}
...
const mapStateToProps = function(store) {
    return {
        ...
        areaCoordinatorFileList: store.areaCoordinatorFileListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorAvatarUpdateOperationContainer);
