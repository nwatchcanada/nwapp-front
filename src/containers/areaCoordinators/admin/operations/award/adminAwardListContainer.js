...
import AdminAreaCoordinatorAwardListComponent from "../../../../../components/areaCoordinators/admin/operations/award/adminAwardListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullAwardList, postAward } from "../../../../../actions/awardActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminAreaCoordinatorAwardListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorAwardListComponent
                slug={slug}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorAwardListContainer);
