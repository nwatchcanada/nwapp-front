...
import AdminAreaCoordinatorBadgeListComponent from "../../../../../components/areaCoordinators/admin/operations/badge/adminBadgeListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullBadgeList, postBadge } from "../../../../../actions/badgeActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminAreaCoordinatorBadgeListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorBadgeListComponent
                slug={slug}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorBadgeListContainer);
