...
import AreaCoordinatorArchiveOperationComponent from "../../../../components/areaCoordinators/admin/operations/adminArchiveOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postAreaCoordinatorDeactivationDetail } from "../../../../actions/areaCoordinatorActions";
import { validateDeactivationInput } from "../../../../validators/areaCoordinatorValidator";


class AreaCoordinatorArchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessCallback(response) {
        ...
        this.props.history.push("/admin/areaCoordinator/"+this.props.areaCoordinatorDetail.slug+"/operations");
    }
    ...
    render() {
        ...
        return (
            <AreaCoordinatorArchiveOperationComponent
                slug={slug}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AreaCoordinatorArchiveOperationContainer);
