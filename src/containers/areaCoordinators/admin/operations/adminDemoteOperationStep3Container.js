...
import AreaCoordinatorDemoteStep3Component from "../../../../components/areaCoordinators/admin/operations/adminDemoteOperationStep3Component";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postAreaCoordinatorDemoteOperation } from "../../../../actions/areaCoordinatorActions";
import {
...
class AdminAreaCoordinatorDemoteOperationStep3Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessfulSubmissionCallback(areaCoordinator) {
        localStorageRemoveItemsContaining("nwapp-areaCoordinator-demote-");
    ...
    onClick(e) {
        ...
        this.props.postAreaCoordinatorDemoteOperation(
            this.getPostData(),
    ...
    render() {
        return (
            <AreaCoordinatorDemoteStep3Component
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postAreaCoordinatorDemoteOperation: (postData, successCallback, failedCallback) => {
            dispatch(postAreaCoordinatorDemoteOperation(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorDemoteOperationStep3Container);
