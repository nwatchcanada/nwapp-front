...
import OrderListComponent from "../../../../../components/areaCoordinators/admin/operations/scorePoint/adminScorePointAddComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { postScorePoint } from "../../../../../actions/scorePointActions";
import { validateScorePointInput } from "../../../../../validators/areaCoordinatorValidator"
import { getTagReactSelectOptions, pullTagList } from "../../../../../actions/tagActions";


class AdminAreaCoordinatorScorePointAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
const mapStateToProps = function(store) {
    return {
        ...
        areaCoordinatorFileList: store.scorePointListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorScorePointAddContainer);
