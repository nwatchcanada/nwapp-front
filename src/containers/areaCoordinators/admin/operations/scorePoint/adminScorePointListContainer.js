...
import AdminAreaCoordinatorScorePointListComponent from "../../../../../components/areaCoordinators/admin/operations/scorePoint/adminScorePointListComponent";
...
class AdminAreaCoordinatorScorePointListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorScorePointListComponent
                slug={slug}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorScorePointListContainer);
