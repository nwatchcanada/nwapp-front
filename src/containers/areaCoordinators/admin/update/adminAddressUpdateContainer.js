...
import AdminAreaCoordinatorAddressUpdateComponent from "../../../../components/areaCoordinators/admin/update/adminAddressUpdateComponent";
import {
...
import { putAreaCoordinatorAddressDetail } from "../../../../actions/areaCoordinatorActions";
import {
    RESIDENCE_TYPE_OF,
    BUSINESS_TYPE_OF,
...
class AdminAreaCoordinatorAddressUpdateContainer extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            streetNumber: this.props.areaCoordinatorDetail.streetNumber,
            streetName: this.props.areaCoordinatorDetail.streetName,
            streetType: this.props.areaCoordinatorDetail.streetType,
            apartmentUnit: this.props.areaCoordinatorDetail.apartmentUnit,
            // streetTypeOption: this.props.areaCoordinatorDetail.organizationName,
            streetTypeOther: this.props.areaCoordinatorDetail.streetTypeOther,
            streetDirection: this.props.areaCoordinatorDetail.streetDirection,
            // streetDirectionOption: this.props.areaCoordinatorDetail.streetDirectionOption,
            postalCode: this.props.areaCoordinatorDetail.postalCode,
            country: this.props.areaCoordinatorDetail.country,
            province: this.props.areaCoordinatorDetail.province,
            city: this.props.areaCoordinatorDetail.city,
            errors: {},
            isLoading: false
        }
    ...
    onProvinceChange(value) {
        ...
        localStorage.setItem('nwapp-create-areaCoordinator-province', value);
    }
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.setState({ errors: {}, isLoading: true, }, ()=>{
                this.props.putAreaCoordinatorAddressDetail(
                    this.getPostData(),
    ...
    render() {
        const {
            ...
            streetTypeOther, streetDirection, postalCode,  country,
            province, city, errors, isLoading
        } = this.state;
        return (
            <AdminAreaCoordinatorAddressUpdateComponent
                slug={slug}
...
const mapDispatchToProps = dispatch => {
    return {
        putAreaCoordinatorAddressDetail: (data, onSuccessCallback, onFailureCallback) => {
            dispatch(
                putAreaCoordinatorAddressDetail(data, onSuccessCallback, onFailureCallback)
            )
        },
