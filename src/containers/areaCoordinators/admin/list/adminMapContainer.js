...
import AdminAreaCoordinatorMapComponent from "../../../../components/areaCoordinators/admin/list/adminMapComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullAreaCoordinatorList } from "../../../../actions/areaCoordinatorActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";


class AdminAreaCoordinatorMapContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    componentDidMount() {
        ...
        this.props.pullAreaCoordinatorList(
            this.state.page,
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullAreaCoordinatorList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullAreaCoordinatorList(page, sizePerPage, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onClick(event, slug) {
        ...
        this.props.history.push("/admin/area-coordinator/"+slug);
    }
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorMapComponent
                page={page}
                sizePerPage={sizePerPage}
                totalSize={totalSize}
                areaCoordinatorList={this.props.areaCoordinatorList}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorMapContainer);
