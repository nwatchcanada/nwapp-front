...
import AdminAreaCoordinatorListComponent from "../../../../components/areaCoordinators/admin/list/adminAreaCoordinatorListComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullAreaCoordinatorList } from "../../../../actions/areaCoordinatorActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";


class AdminAreaCoordinatorListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorListComponent
                page={page}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorListContainer);
