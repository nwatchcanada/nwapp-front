...
import AdminAreaCoordinatorFileUploadListComponent from "../../../../../components/areaCoordinators/admin/retrieve/fileUpload/adminFileUploadListComponent";
...
class AdminAreaCoordinatorFileUploadListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        const areaCoordinatorFileList = this.props.areaCoordinatorFileList && this.props.areaCoordinatorFileList.results ? this.props.areaCoordinatorFileList.results : [];
        return (
            <AdminAreaCoordinatorFileUploadListComponent
                slug={slug}
                areaCoordinator={areaCoordinator}
                areaCoordinatorFiles={areaCoordinatorFileList}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorFileUploadListContainer);
