...
import AdminAreaCoordinatorLiteRetrieveComponent from "../../../../components/areaCoordinators/admin/retrieve/adminLiteRetrieveComponent";
...
class AdminAreaCoordinatorLiteRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorLiteRetrieveContainer);
