...
import AdminAreaCoordinatorCreateStep7Component from "../../../../components/areaCoordinators/admin/create/adminCreateStep7Component";
...
class AdminAreaCoordinatorCreateStep7Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            gender: localStorage.getItem("nwapp-create-areaCoordinator-gender"),
            isHowHearLoading: true,
            howDidYouHear: localStorageGetIntegerItem("nwapp-create-areaCoordinator-howDidYouHear"),
            ...
            meaning: localStorageGetIntegerItem("nwapp-create-areaCoordinator-meaning"),
            meaningOther: localStorage.getItem("nwapp-create-areaCoordinator-meaningOther"),
            isExpectationLoading: true,
            expectation: localStorageGetIntegerItem("nwapp-create-areaCoordinator-expectation"),
            ...
            organizationEmployeeCount: localStorageGetIntegerItem("nwapp-create-areaCoordinator-under18YearsHouseholdCount"),
    ...
    onSuccessfulSubmissionCallback(areaCoordinator) {
        ...
        this.props.history.push("/admin/areaCoordinators/add/step-8");
    }
    ...
    render() {
        ...
        return (
            <AdminAreaCoordinatorCreateStep7Component
                typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorCreateStep7Container);
