...
import { validateStep1CreateInput } from "../../../../validators/areaCoordinatorValidator";
import {
...
class AdminAreaCoordinatorCreateStep1Container extends Component {
    ...
    onSuccessfulSubmissionCallback(areaCoordinator) {
        ...
        localStorageSetObjectOrArrayItem("nwapp-create-areaCoordinator-search-criteria", this.state);
        this.props.history.push("/admin/areaCoordinators/add/step-2");
    }
