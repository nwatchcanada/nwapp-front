...
import AdminAreaCoordinatorCreateStep8Component from "../../../../components/areaCoordinators/admin/create/adminCreateStep8Component";
...
import { postAreaCoordinatorDetail } from '../../../../actions/areaCoordinatorActions';
import { validateStep8CreateInput } from '../../../../validators/areaCoordinatorValidator';


class AdminAreaCoordinatorCreateStep8Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            organizationTypeOfLabel: localStorage.getItem("nwapp-create-areaCoordinator-organizationTypeOfLabel"),
            ...
            streetTypeLabel: localStorage.getItem("nwapp-create-areaCoordinator-streetTypeLabel"),
            ...
            streetDirectionLabel: localStorage.getItem("nwapp-create-areaCoordinator-streetDirectionLabel"),
            ...
            watchSlug: localStorage.getItem('nwapp-create-areaCoordinator-watch-slug'),
            watchIcon: localStorage.getItem('nwapp-create-areaCoordinator-watch-icon'),
            watchName: localStorage.getItem('nwapp-create-areaCoordinator-watch-name'),
            typeOf: localStorageGetIntegerItem("nwapp-create-areaCoordinator-typeOf"),
            tags: localStorageGetArrayItem("nwapp-create-areaCoordinator-tags"),
            yearOfBirth: localStorage.getItem("nwapp-create-areaCoordinator-yearOfBirth"),
            gender: localStorageGetIntegerItem("nwapp-create-areaCoordinator-gender"),
            genderLabel: localStorage.getItem("nwapp-create-areaCoordinator-gender-label"),
            howDidYouHearLabel: localStorage.getItem("nwapp-create-areaCoordinator-howDidYouHearLabel"),
            howDidYouHear: localStorage.getItem("nwapp-create-areaCoordinator-howDidYouHear"),
            howDidYouHearOption: localStorageGetObjectItem('nwapp-create-areaCoordinator-howDidYouHearOption'),
            howDidYouHearOther: localStorage.getItem("nwapp-create-areaCoordinator-howDidYouHearOther"),
            meaningLabel: localStorage.getItem("nwapp-create-areaCoordinator-meaningLabel"),
            meaning: localStorage.getItem("nwapp-create-areaCoordinator-meaning"),
            meaningOther: localStorage.getItem("nwapp-create-areaCoordinator-meaningOther"),
            expectationLabel: localStorage.getItem("nwapp-create-areaCoordinator-expectationLabel"),
            expectation: localStorage.getItem("nwapp-create-areaCoordinator-expectation"),
            expectationOther: localStorage.getItem("nwapp-create-areaCoordinator-expectationOther"),
            willingToVolunteerLabel: localStorage.getItem("nwapp-create-areaCoordinator-willingToVolunteer-label"),
            willingToVolunteer: localStorageGetIntegerItem("nwapp-create-areaCoordinator-willingToVolunteer"),
            anotherHouseholdAreaCoordinatorRegisteredLabel: localStorage.getItem("nwapp-create-areaCoordinator-anotherHouseholdAreaCoordinatorRegistered-label"),
            anotherHouseholdAreaCoordinatorRegistered: localStorageGetIntegerItem("nwapp-create-areaCoordinator-anotherHouseholdAreaCoordinatorRegistered"),
            totalHouseholdCount: localStorageGetIntegerItem("nwapp-create-areaCoordinator-totalHouseholdCount"),
            under18YearsHouseholdCount: localStorageGetIntegerItem("nwapp-create-areaCoordinator-under18YearsHouseholdCount"),
            organizationEmployeeCount: localStorageGetIntegerItem("nwapp-create-areaCoordinator-organizationEmployeeCount"),
            organizationFoundingYear: localStorageGetIntegerItem("nwapp-create-areaCoordinator-organizationFoundingYear"),
            errors: {},
            isLoading: false
        }
    ...
    getPostData() {
        ...
        postData.anotherHouseholdAreaCoordinatorRegistered = this.state.anotherHouseholdAreaCoordinatorRegistered === 1;
    ...
    onSubmitClick(e) {
        ...
        if (isValid) {
            this.setState({
                ...
                this.props.postAreaCoordinatorDetail(
                    this.getPostData(),
    ...
    onSuccessCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                localStorageRemoveItemsContaining("nwapp-create-areaCoordinator-");
                this.props.setFlashMessage("success", "AreaCoordinator has been successfully created.");
                this.props.history.push("/admin/areaCoordinator/"+response['slug']);
            }
        )
    }
    ...
    render() {
        const {
            ...
            willingToVolunteerLabel, willingToVolunteer, anotherHouseholdAreaCoordinatorRegisteredLabel, anotherHouseholdAreaCoordinatorRegistered, totalHouseholdCount, under18YearsHouseholdCount,
            organizationEmployeeCount, organizationFoundingYear, organizationType, organizationTypeOfLabel,
        } = this.state;

        return (
            <AdminAreaCoordinatorCreateStep8Component
                typeOf={typeOf}
                ...
                anotherHouseholdAreaCoordinatorRegisteredLabel={anotherHouseholdAreaCoordinatorRegisteredLabel}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postAreaCoordinatorDetail: (postData, successCallback, failedCallback) => {
            dispatch(postAreaCoordinatorDetail(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAreaCoordinatorCreateStep8Container);
