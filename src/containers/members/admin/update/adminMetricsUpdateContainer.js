...
import AdminMemberMetricUpdateComponent from "../../../../components/members/admin/update/adminMetricsUpdateComponent";
...
class AdminMemberMetricUpdateContainer extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            over18YearsHouseholdCount: this.props.memberDetail.over18YearsHouseholdCount,
