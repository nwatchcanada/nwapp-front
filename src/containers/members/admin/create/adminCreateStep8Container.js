...
import AdminMemberCreateStep8Component from "../../../../components/members/admin/create/adminCreateStep8Component";
...
class AdminMemberCreateStep8Container extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            province: localStorage.getItem("nwapp-create-member-province"),
            city: localStorage.getItem("nwapp-create-member-city"),
