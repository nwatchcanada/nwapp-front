...
import AdminMemberFileUploadListComponent from "../../../../../components/members/admin/retrieve/fileUpload/adminFileUploadListComponent";
...
class AdminMemberFileUploadListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminMemberFileUploadListComponent
                slug={slug}
                member={member}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminMemberFileUploadListContainer);
