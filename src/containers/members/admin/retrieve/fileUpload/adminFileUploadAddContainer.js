...
import OrderListComponent from "../../../../../components/members/admin/retrieve/fileUpload/adminFileUploadAddComponent";
...
class AdminMemberFileUploadAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminMemberFileUploadAddContainer);
