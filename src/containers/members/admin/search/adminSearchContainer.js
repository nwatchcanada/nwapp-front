...
import AdminMemberSearchComponent from "../../../../components/members/admin/search/adminSearchComponent";
import { validateSearchInput } from "../../../../validators/memberValidator";
		...
		if (e.keyCode === 13) {
			this.setState({ advancedSearchActive: false, }, ()=> {
				...
				if (isValid) {
					...
					localStorageSetObjectOrArrayItem('workery-search-member-details', this.state);
					this.props.history.push("/admin/members/search-results");
