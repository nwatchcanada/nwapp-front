...
import AdminMemberMetricsUpdateComponent from "../../../../components/members/update/admin/adminMemberMetricsUpdateComponent";
...
class AdminMemberMetricsUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminMemberMetricsUpdateContainer);
