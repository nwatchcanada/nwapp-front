...
import StaffFullListComponent from "../../components/staff/staffListInactiveComponent";
import { clearFlashMessage } from "../../actions/flashMessageActions";


class StaffListInactiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        const tableData = [{
            ...
            'absoluteUrl': '/staff/inactive/argyle'
        },{
            'slug': 'byron',
            'icon': 'home',
            'number': 2,
            ...
            'absoluteUrl': '/staff/inactive/byron'
        },{
            'slug': 'carling',
            'icon': 'briefcase',
            'number': 3,
            ...
            'absoluteUrl': '/staff/inactive/carling'
        }];
        return (
            <StaffFullListComponent
