...
import AdminAssociateDistrictStep2Container from "./associates/admin/operations/district/step2Container";
...
import AdminDistrictRetrieveMapContainer from "./settings/admin/district/retrieve/adminRetrieveMapContainer";
import AdminDistrictRetrieveOperationsContainer from "./settings/admin/district/retrieve/adminRetrieveOperationsContainer";
...
import AdminWatchMapContainer from "./watches/admin/list/adminMapContainer";
...
import AdminWatchMapBoundaryContainer from "./watches/admin/retrieve/adminRetrieveMapContainer";
...
import AdminWatchBoundryOperationContainer from "./watches/admin/operations/boundry/adminBoundryContainer";
...
import ItemCreateStep6ConcernContainer from "./items/admin/create/concern/itemCreateStep6ConcernContainer";
...
import ItemCreateStep6EventContainer from "./items/admin/create/event/itemCreateStep6EventContainer";
...
import ItemCreateStep6IncidentContainer from "./items/admin/create/incident/itemCreateStep6IncidentContainer";
...
import ItemCreateStep7VolunteerContainer from "./items/admin/create/volunteer/itemCreateStep7VolunteerContainer";
...
import EventItemDetailUpdateContainer from "./items/admin/update/details/eventItemDetailUpdateContainer";
import ConcernItemDetailUpdateContainer from "./items/admin/update/details/concernItemDetailUpdateContainer";
...
import Report08Container from "./reports/report08Container";
                        ...
                        <main id="main" role="main">
                            ...
                            <Switch>
                                ...
                                */
                                ...
                                <Route path="/admin/watches/map" exact component={requiresAuth(AdminWatchMapContainer)} />
                                ...
                                <Route path="/admin/watch/:slug/operation/boundry" exact component={requiresAuth(AdminWatchBoundryOperationContainer)} />
                                ...
                                */
                                ...
                                <Route path="/admin/report/8" exact component={requiresAuth(Report08Container)} />
                                ...
                                */
                                ...
                                <Route path="/admin/item/add/step-6-concern" exact component={requiresAuth(ItemCreateStep6ConcernContainer)} />
                                ...
                                <Route path="/admin/item/add/step-6-event" exact component={requiresAuth(ItemCreateStep6EventContainer)} />
                                ...
                                <Route path="/admin/item/add/step-6-incident" exact component={requiresAuth(ItemCreateStep6IncidentContainer)} />
                                ...
                                <Route path="/admin/item/add/step-7-volunteer" exact component={requiresAuth(ItemCreateStep7VolunteerContainer)} />
                                ...
                                <Route path="/admin/item/:slug/update-event-details" exact component={requiresAuth(EventItemDetailUpdateContainer)} />
                                <Route path="/admin/item/:slug/update-concern-details" exact component={requiresAuth(ConcernItemDetailUpdateContainer)} />
