...
import AssociateFullListComponent from "../../components/associates/associateListInactiveComponent";
import { clearFlashMessage } from "../../actions/flashMessageActions";


class AssociateListInactiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        const tableData = [{
            ...
            'absoluteUrl': '/associates/inactive/argyle'
        },{
            'slug': 'byron',
            'icon': 'home',
            'number': 2,
            ...
            'absoluteUrl': '/associates/inactive/byron'
        },{
            'slug': 'carling',
            'icon': 'briefcase',
            'number': 3,
            ...
            'absoluteUrl': '/associates/inactive/carling'
        }];
        return (
            <AssociateFullListComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateListInactiveContainer);
