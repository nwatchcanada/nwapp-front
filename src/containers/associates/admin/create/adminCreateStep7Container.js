...
import AdminAssociateCreateStep7Component from "../../../../components/associates/admin/create/adminCreateStep7Component";
...
class AdminAssociateCreateStep7Container extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            gender: localStorage.getItem("nwapp-create-associate-gender"),
            isHowHearLoading: true,
            howDidYouHear: localStorageGetIntegerItem("nwapp-create-associate-howDidYouHear"),
            ...
            meaning: localStorageGetIntegerItem("nwapp-create-associate-meaning"),
    ...
    onSuccessfulSubmissionCallback(associate) {
        ...
        this.props.history.push("/admin/associates/add/step-8");
    }
