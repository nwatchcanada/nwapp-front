...
import AdminAssociateAwardListComponent from "../../../../../components/associates/admin/operations/award/adminAwardListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullAwardList, postAward } from "../../../../../actions/awardActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminAssociateAwardListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAssociateAwardListComponent
                slug={slug}
                associate={associate}
                awardList={awardList}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateAwardListContainer);
