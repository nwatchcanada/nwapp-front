...
import AssociateArchiveOperationComponent from "../../../../components/associates/admin/operations/adminArchiveOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postAssociateDeactivationDetail } from "../../../../actions/associateActions";
import { validateDeactivationInput } from "../../../../validators/associateValidator";


class AssociateArchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    getPostData() {
        ...
        postData.associate = this.props.associateDetail.slug;
    ...
    onSuccessCallback(response) {
        ...
        this.props.setFlashMessage("success", "Associate has been successfully deactivated.");
        this.props.history.push("/admin/associate/"+this.props.associateDetail.slug+"/operations");
    }
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.setState({ isLoading: true, errors: [], }, ()=>{
                this.props.postAssociateDeactivationDetail(
                    this.getPostData(),
    ...
    render() {
        ...
        return (
            <AssociateArchiveOperationComponent
                slug={slug}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postAssociateDeactivationDetail: (postData, onSuccessCallback, onFailureCallback) => {
            dispatch(
                postAssociateDeactivationDetail(postData, onSuccessCallback, onFailureCallback)
            )
        },
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateArchiveOperationContainer);
