...
import AssociateAvatarUpdateOperationComponent from "../../../../components/associates/admin/operations/adminAvatarUpdateOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postAssociateAvatarCreateOrUpdateOperation } from "../../../../actions/associateActions";
import { validateImageInput } from "../../../../validators/fileValidator"


class AdminAssociateAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postAssociateAvatarCreateOrUpdateOperation(
                this.getPostData(),
    ...
    render() {
        ...
        return (
            <AssociateAvatarUpdateOperationComponent
                slug={slug}
                associate={associate}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postAssociateAvatarCreateOrUpdateOperation: (postData, successCallback, failedCallback) => {
            dispatch(postAssociateAvatarCreateOrUpdateOperation(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateAvatarUpdateOperationContainer);
