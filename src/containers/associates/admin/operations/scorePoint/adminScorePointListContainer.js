...
import AdminAssociateScorePointListComponent from "../../../../../components/associates/admin/operations/scorePoint/adminScorePointListComponent";
...
class AdminAssociateScorePointListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAssociateScorePointListComponent
                slug={slug}
                associate={associate}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateScorePointListContainer);
