...
import OrderListComponent from "../../../../../components/associates/admin/operations/scorePoint/adminScorePointAddComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { postScorePoint } from "../../../../../actions/scorePointActions";
import { validateScorePointInput } from "../../../../../validators/associateValidator"
import { getTagReactSelectOptions, pullTagList } from "../../../../../actions/tagActions";


class AdminAssociateScorePointAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Score has been successfully added to associate.");
                this.props.history.push("/admin/associate/"+this.state.slug+"/community/score-points");
            }
        )
    }
...
const mapStateToProps = function(store) {
    return {
        ...
        associateFileList: store.scorePointListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateScorePointAddContainer);
