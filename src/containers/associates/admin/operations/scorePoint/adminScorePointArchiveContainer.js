...
import AdminAssociateScorePointArchiveComponent from "../../../../../components/associates/admin/operations/scorePoint/adminScorePointArchiveComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { deleteScorePoint } from "../../../../../actions/scorePointActions";


class AdminAssociateScorePointArchiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAssociateScorePointArchiveComponent
                slug={slug}
                associate={associate}
                isLoading={isLoading}
                errors={errors}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateScorePointArchiveContainer);
