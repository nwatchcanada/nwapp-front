...
import AdminAssociateUnarchiveOperationComponent from "../../../../components/associates/admin/operations/adminUnarchiveOperationComponent";
...
class AdminAssociateUnarchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessCallback(response) {
        ...
        this.props.setFlashMessage("success", "Associate has been successfully activated.");
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateUnarchiveOperationContainer);
