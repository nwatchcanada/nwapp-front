...
import AdminAssociateBadgeAddComponent from "../../../../../components/associates/admin/operations/badge/adminBadgeAddComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { postBadge } from "../../../../../actions/badgeActions";
import { validateBadgeInput } from "../../../../../validators/associateValidator"
import { getTagReactSelectOptions, pullTagList } from "../../../../../actions/tagActions";


class AdminAssociateBadgeAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAssociateBadgeAddComponent
                slug={slug}
                typeOf={typeOf}
...
const mapStateToProps = function(store) {
    return {
        ...
        associateFileList: store.badgeListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateBadgeAddContainer);
