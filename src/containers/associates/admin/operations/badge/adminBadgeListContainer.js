...
import AdminAssociateBadgeListComponent from "../../../../../components/associates/admin/operations/badge/adminBadgeListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullBadgeList, postBadge } from "../../../../../actions/badgeActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminAssociateBadgeListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAssociateBadgeListComponent
                slug={slug}
                associate={associate}
                badgeList={badgeList}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateBadgeListContainer);
