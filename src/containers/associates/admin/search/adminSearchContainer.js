...
import AdminAssociateSearchComponent from "../../../../components/associates/admin/search/adminSearchComponent";
		...
		if (e.keyCode === 13) {
			this.setState({ advancedSearchActive: false, }, ()=> {
				...
				if (isValid) {
					...
					this.props.history.push("/admin/associates/search-results");
