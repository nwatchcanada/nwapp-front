...
import AdminAssociateMetricUpdateComponent from "../../../../components/associates/admin/update/adminMetricsUpdateComponent";
...
class AdminAssociateMetricUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isTagsLoading: true,
            tags: transcodedTags,
            yearOfBirth: this.props.associateDetail.yearOfBirth,
            gender: this.props.associateDetail.gender,
            isHowHearLoading: true,
            howDidYouHear: this.props.associateDetail.howDidYouHear,
            // howDidYouHearOption: localStorageGetObjectItem('nwapp-create-associate-howDidYouHearOption'),
            howDidYouHearOther: this.props.associateDetail.howDidYouHearOther,
            isMeaningLoading: true,
            meaning: this.props.associateDetail.meaning,
            meaningOther: this.props.associateDetail.meaningOther,
            ...
            over18YearsHouseholdCount: this.props.associateDetail.over18YearsHouseholdCount,
            organizationEmployeeCount: this.props.associateDetail.organizationEmployeeCount,
            organizationFoundingYear: this.props.associateDetail.organizationFoundingYear,
    ...
    onMultiChange(...args) {
        ...
        const key = 'nwapp-create-associate-' + args[1].name;
    ...
    render() {
        ...
        return (
            <AdminAssociateMetricUpdateComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateMetricUpdateContainer);
