...
import Report02Component from "../../components/reports/report02Component";
import { clearFlashMessage } from "../../actions/flashMessageActions";
import { NWAPP_REPORT_TWO_CSV_DOWNLOAD_API_ENDPOINT } from "../../constants/api";
import { getSubdomain } from "../../helpers/urlUtility";


class Report02Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        const url = process.env.REACT_APP_API_PROTOCOL + "://" + schema + "." + process.env.REACT_APP_API_DOMAIN + "/api" + NWAPP_REPORT_TWO_CSV_DOWNLOAD_API_ENDPOINT;
        console.log(url);
