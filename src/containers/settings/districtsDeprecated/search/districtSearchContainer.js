...
import DistrictSearchComponent from "../../../../components/settings/districts/search/districtSearchComponent";
...
class DistrictListContainer extends Component {
    ...
    onSearchClick() {
        this.props.history.push("/settings/districts/search-results");
    }
