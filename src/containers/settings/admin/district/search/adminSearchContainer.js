...
import AdminDistrictSearchComponent from "../../../../../components/settings/admin/district/search/adminSearchComponent";
import { validateSearchInput } from "../../../../../validators/districtValidator";
import { localStorageSetObjectOrArrayItem } from '../../../../../helpers/localStorageUtility';


class AdminDistrictSearchContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
	...
	handleKeyDown(e) {
		...
		if (e.keyCode === 13) {
			this.setState({ advancedSearchActive: false, }, ()=> {
				// Perform district-side validation.
				const { errors, isValid } = validateSearchInput(this.state);

				// CASE 1 OF 2: Validation passed successfully.
				if (isValid) {

					localStorageSetObjectOrArrayItem('workery-search-district-details', this.state);
					this.props.history.push("/admin/settings/district/search-results");
