...
import AdminDistrictMapComponent from "../../../../../components/settings/admin/district/list/adminMapComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullDistrictList } from "../../../../../actions/districtActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../../constants/api";


class AdminDistrictMapContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullDistrictList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullDistrictList(page, sizePerPage, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onClick(event, typeOfCode, slug) {
        event.preventDefault();
        const aURL = "/admin/settings/district/" + typeOfCode + "/" + slug;
        console.log(typeOfCode, slug, aURL);
