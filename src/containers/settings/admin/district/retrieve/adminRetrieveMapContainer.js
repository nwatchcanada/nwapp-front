...
import AdminDistrictRetrieveMapComponent from "../../../../../components/settings/admin/district/retrieve/adminRetrieveMapComponent";
...
class AdminDistrictRetrieveMapContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminDistrictRetrieveMapContainer);
