...
import AdminDistrictRetrieveOperationsComponent from "../../../../../components/settings/admin/district/retrieve/adminRetrieveOperationsComponent";
...
class AdminDistrictRetrieveOperationsContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminDistrictRetrieveOperationsContainer);
