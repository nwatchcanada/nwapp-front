...
import AdminTagListComponent from "../../../../../components/settings/admin/tag/list/adminListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullTagList } from "../../../../../actions/tagActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminTagListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullTagList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullTagList(page, sizePerPage, this.state.parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
    ...
    render() {
        ...
        const tagList = this.props.tagList && this.props.tagList.results ? this.props.tagList.results : [];
