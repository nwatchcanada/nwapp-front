...
import AdminResourceUpdateImageComponent from "../../../../../components/settings/admin/resource/update/adminUpdateImageComponent";
...
class AdminResourceUpdateImageContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            file: this.props.resource.imageUrl,
            uploadContent: null,
            uploadFilename: null,
        }
    ...
    render() {
        const { slug, category, name, file, description, errors, isLoading } = this.state;
        return (
            <AdminResourceUpdateImageComponent
                slug={slug}
                category={category}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminResourceUpdateImageContainer);
