...
class AdminResourceListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        const resourceList = this.props.resourceList && this.props.resourceList.results ? this.props.resourceList.results : [];
...
const mapStateToProps = function(store) {
    return {
        ...
        resourceList: store.resourceListState,
