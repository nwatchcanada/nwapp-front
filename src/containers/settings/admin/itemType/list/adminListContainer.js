...
import AdminItemTypeListComponent from "../../../../../components/settings/admin/itemType/list/adminListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullItemTypeList } from "../../../../../actions/itemTypeActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminItemTypeListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullItemTypeList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullItemTypeList(page, sizePerPage, this.state.parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
    ...
    render() {
        ...
        const itemTypeList = this.props.itemTypeList && this.props.itemTypeList.results ? this.props.itemTypeList.results : [];

        return (
            <AdminItemTypeListComponent
                member={member}
