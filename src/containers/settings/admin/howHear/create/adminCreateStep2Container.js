...
import AdminHowHearCreateStep2Component from "../../../../../components/settings/admin/howHear/create/adminCreateStep2Component";
...
class AdminHowHearCreateStep2Container extends Component {
    ...
    render() {
        ...
        return (
            <AdminHowHearCreateStep2Component
                name={name}
                errors={errors}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminHowHearCreateStep2Container);
