...
import AdminHowHearCreateStep1Component from "../../../../../components/settings/admin/howHear/create/adminCreateStep1Component";
import { validateInput } from "../../../../../validators/howHearValidator";


class AdminHowHearCreateStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessfulSubmissionCallback(howHear) {
        ...
        this.props.history.push("/admin/settings/how-hear/add/step-2");
    }
    ...
    onTextChange(e) {
        ...
        localStorage.setItem('nwapp-howHear-add-'+[e.target.name], e.target.value);
    }
    ...
    render() {
        ...
        return (
            <AdminHowHearCreateStep1Component
                text={text}
                errors={errors}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminHowHearCreateStep1Container);
