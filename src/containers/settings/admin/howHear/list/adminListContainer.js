...
import AdminHowHearListComponent from "../../../../../components/settings/admin/howHear/list/adminListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullHowHearList } from "../../../../../actions/howHearActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminHowHearListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullHowHearList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullHowHearList(page, sizePerPage, this.state.parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
    ...
    render() {
        ...
        const howHearList = this.props.howHearList && this.props.howHearList.results ? this.props.howHearList.results : [];

        return (
            <AdminHowHearListComponent
                member={member}
                howHearList={howHearList}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullHowHearList: (page, sizePerPage, map, onSuccessListCallback, onFailureListCallback) => {
            dispatch(
                pullHowHearList(page, sizePerPage, map, onSuccessListCallback, onFailureListCallback)
            )
        },
