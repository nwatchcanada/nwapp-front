...
import AdminAnnouncementRetrieveComponent from "../../../../../components/settings/admin/announcement/retrieve/adminRetrieveComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullAnnouncement } from '../../../../../actions/announcementActions';
import {
    localStorageGetObjectItem, localStorageSetObjectOrArrayItem
} from '../../../../../helpers/localStorageUtility';


class AdminAnnouncementRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        // Prevent the default HTML form submit code to run on the browser side.
        e.preventDefault();
        this.props.history.push("/admin/settings/announcement/"+this.state.slug+"/update");
    }
    ...
    render() {
        return (
            <AdminAnnouncementRetrieveComponent
                announcementData={this.props.announcement}
                onBack={this.onBack}
...
const mapStateToProps = function(store) {
    return {
        announcement: store.announcementDetailState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAnnouncementRetrieveContainer);
