...
import AdminAnnouncementCreateStep1Component from "../../../../../components/settings/admin/announcement/create/adminCreateStep1Component";
import { validateInput } from "../../../../../validators/announcementValidator";


class AdminAnnouncementCreateStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessfulSubmissionCallback(announcement) {
        ...
        this.props.history.push("/admin/settings/announcement/add/step-2");
    }
    ...
    onTextChange(e) {
        ...
        localStorage.setItem('nwapp-announcement-add-'+[e.target.name], e.target.value);
    }
    ...
    render() {
        ...
        return (
            <AdminAnnouncementCreateStep1Component
                text={text}
                errors={errors}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAnnouncementCreateStep1Container);
