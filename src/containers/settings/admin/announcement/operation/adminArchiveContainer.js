...
import AdminAnnouncementArchiveComponent from "../../../../../components/settings/admin/announcement/operation/adminArchiveComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { deleteAnnouncement } from "../../../../../actions/announcementActions";


class AdminAnnouncementArchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Announcement have been successfully archived.");
...
const mapStateToProps = function(store) {
    return {
        ...
        announcementDetail: store.announcementDetailState,
    };
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAnnouncementArchiveOperationContainer);
