...
import AdminAnnouncementListComponent from "../../../../../components/settings/admin/announcement/list/adminListComponent";
import { clearFlashMessage } from "../../../../../actions/flashMessageActions";
import { pullAnnouncementList } from "../../../../../actions/announcementActions";
import { validateInput } from "../../../../../validators/fileValidator"


class AdminAnnouncementListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    componentDidMount() {
        ...
        // Get our data.
        this.props.pullAnnouncementList(
            this.state.page,
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullAnnouncementList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullAnnouncementList(page, sizePerPage, this.state.parametersMap, this.onSuccessListCallback, this.onFailureListCallback);
                }
            );
    ...
    render() {
        ...
        const announcementList = this.props.announcementList && this.props.announcementList.results ? this.props.announcementList.results : [];
...
const mapStateToProps = function(store) {
    return {
        ...
        announcementList: store.announcementListState,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullAnnouncementList: (page, sizePerPage, map, onSuccessListCallback, onFailureListCallback) => {
            dispatch(
                pullAnnouncementList(page, sizePerPage, map, onSuccessListCallback, onFailureListCallback)
            )
        },
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAnnouncementListContainer);
