...
import WatchCreateStep3BizComponent from "../../../../components/watches/create/biz/watchCreateStep3BizComponent";
import {
...
class WatchCreateStep2BizContainer extends Component {
    ...
    onSuccessfulSubmissionCallback(district) {
        ...
        this.props.history.push("/watches/step-4-create-biz");
    }
    ...
    onMultiChange(...args) {
        ...
        const key = 'nwapp-watch-biz-' + args[1].name;
