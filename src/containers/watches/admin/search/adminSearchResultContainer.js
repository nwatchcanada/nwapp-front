...
class AdminWatchSearchResultContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        const search = localStorageGetObjectItem('workery-search-watch-details');
        this.state = {
            // Pagination
            page: 1,
            sizePerPage: 100,
    ...
    componentDidMount() {
        ...
        this.setState(
            ...
            ()=>{
                // STEP 3:
                // SUBMIT TO OUR API.
                this.props.pullWatchList(this.state.page, this.state.sizePerPage, this.getParametersMapFromState(), this.onSuccessCallback, this.onFailureCallback);
            }
        );
    }
    ...
    onWatchClick(e, watchId, watchGivenName, watchLastName) {
        this.setState(
            { isLoading: true },
            ()=>{
                this.props.history.push("/admin/watch/"+watchId+"");
            }
        );
    }
    ...
    render() {
        ...
        return (
            <AdminWatchSearchResultComponent
                page={page}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchSearchResultContainer);
