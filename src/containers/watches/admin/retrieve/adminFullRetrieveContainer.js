...
import AdminWatchFullRetrieveComponent from "../../../../components/watchs/admin/retrieve/adminFullRetrieveComponent";
...
class AdminWatchFullRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminWatchFullRetrieveComponent
                slug={slug}
                watch={watch}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchFullRetrieveContainer);
