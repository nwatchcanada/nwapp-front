...
import AdminWatchFileUploadListComponent from "../../../../../components/watches/admin/retrieve/fileUpload/adminFileUploadListComponent";
...
class AdminWatchFileUploadListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        const watchFileList = this.props.watchFileList && this.props.watchFileList.results ? this.props.watchFileList.results : [];
        return (
            <AdminWatchFileUploadListComponent
                slug={slug}
                watch={watch}
                watchFiles={watchFileList}
...
const mapStateToProps = function(store) {
    return {
        ...
        watchFileList: store.privateFileUploadListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchFileUploadListContainer);
