...
class AdminWatchFileUploadAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Watch file has been successfully created.");
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchFileUploadAddContainer);
