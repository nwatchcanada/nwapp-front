...
class AdminWatchCommentContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    componentDidMount() {
        ...
        // Get our data.
        this.props.pullWatchCommentList(
            this.state.page,
    ...
    render() {
        ...
        const watchComments = this.props.watchCommentList ? this.props.watchCommentList.results : [];
        return (
            <AdminWatchCommentComponent
                slug={slug}
                text={text}
                watch={watch}
...
const mapStateToProps = function(store) {
    return {
        ...
        watchCommentList: store.watchCommentListState,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullWatchCommentList: (page, sizePerPage, map, onSuccessListCallback, onFailureListCallback) => {
            dispatch(
                pullWatchCommentList(page, sizePerPage, map, onSuccessListCallback, onFailureListCallback)
            )
        },
        postWatchComment: (postData, successCallback, failedCallback) => {
            dispatch(postWatchComment(postData, successCallback, failedCallback))
        },
    }
}
