...
import AdminWatchContactUpdateComponent from "../../../../components/watchs/admin/update/adminContactUpdateComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { validateContactInput } from "../../../../validators/watchValidator";
import {
...
import { putWatchContactDetail } from "../../../../actions/watchActions";


class AdminWatchContactUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.setState({ errors: {}, isLoading: true, }, ()=>{
                this.props.putWatchContactDetail(
                    this.getPostData(),
    ...
    render() {
        ...
        return (
            <AdminWatchContactUpdateComponent
                // STEP 3
                typeOf={typeOf}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        putWatchContactDetail: (data, onSuccessCallback, onFailureCallback) => {
            dispatch(
                putWatchContactDetail(data, onSuccessCallback, onFailureCallback)
            )
        },
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchContactUpdateContainer);
