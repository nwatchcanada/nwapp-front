...
import AdminWatchMetricUpdateComponent from "../../../../components/watchs/admin/update/adminMetricsUpdateComponent";
...
import { putWatchMetricsDetail } from "../../../../actions/watchActions";
import {
    RESIDENCE_TYPE_OF,
    BUSINESS_TYPE_OF,
...
class AdminWatchMetricUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        const anotherHouseholdWatchRegistered = this.props.watchDetail.anotherHouseholdWatchRegistered === true ? 1 : 0;
        ...
        this.state = {
            ...
            isTagsLoading: true,
            tags: transcodedTags,
            yearOfBirth: this.props.watchDetail.yearOfBirth,
            gender: this.props.watchDetail.gender,
            isHowHearLoading: true,
            howDidYouHear: this.props.watchDetail.howDidYouHear,
            // howDidYouHearOption: localStorageGetObjectItem('nwapp-create-watch-howDidYouHearOption'),
            howDidYouHearOther: this.props.watchDetail.howDidYouHearOther,
            isMeaningLoading: true,
            meaning: this.props.watchDetail.meaning,
            meaningOther: this.props.watchDetail.meaningOther,
            isExpectationLoading: true,
            expectation: this.props.watchDetail.expectation,
            expectationOther: this.props.watchDetail.expectationOther,
            willingToVolunteer: this.props.watchDetail.willingToVolunteer,
            anotherHouseholdWatchRegistered: anotherHouseholdWatchRegistered,
            totalHouseholdCount: this.props.watchDetail.totalHouseholdCount,
            under18YearsHouseholdCount: this.props.watchDetail.under18YearsHouseholdCount,
            organizationEmployeeCount: this.props.watchDetail.organizationEmployeeCount,
            organizationFoundingYear: this.props.watchDetail.organizationFoundingYear,
    ...
    getPostData() {
        ...
        try { // Convert to boolean type.
            postData.anotherHouseholdWatchRegistered = parseInt(this.state.anotherHouseholdWatchRegistered) === 1;
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.setState({ errors: {}, isLoading: true, }, ()=>{
                this.props.putWatchMetricsDetail(
                    this.getPostData(),
    ...
    render() {
        ...
        return (
            <AdminWatchMetricUpdateComponent
                ...
                anotherHouseholdWatchRegistered={parseInt(anotherHouseholdWatchRegistered)}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        putWatchMetricsDetail: (data, onSuccessCallback, onFailureCallback) => {
            dispatch(
                putWatchMetricsDetail(data, onSuccessCallback, onFailureCallback)
            )
        },
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchMetricUpdateContainer);
