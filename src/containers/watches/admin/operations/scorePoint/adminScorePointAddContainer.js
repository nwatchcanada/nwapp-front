...
import OrderListComponent from "../../../../../components/watchs/admin/operations/scorePoint/adminScorePointAddComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { postScorePoint } from "../../../../../actions/scorePointActions";
import { validateScorePointInput } from "../../../../../validators/watchValidator"
import { getTagReactSelectOptions, pullTagList } from "../../../../../actions/tagActions";


class AdminWatchScorePointAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
const mapStateToProps = function(store) {
    return {
        ...
        watchFileList: store.scorePointListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchScorePointAddContainer);
