...
import AdminWatchBadgeAddComponent from "../../../../../components/watchs/admin/operations/badge/adminBadgeAddComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { postBadge } from "../../../../../actions/badgeActions";
import { validateBadgeInput } from "../../../../../validators/watchValidator"
import { getTagReactSelectOptions, pullTagList } from "../../../../../actions/tagActions";


class AdminWatchBadgeAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Score has been successfully added to watch.");
...
const mapStateToProps = function(store) {
    return {
        ...
        watchFileList: store.badgeListState,
