...
class AdminWatchUnarchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessCallback(response) {
        ...
        this.props.setFlashMessage("success", "Watch has been successfully activated.");
        this.props.history.push("/admin/watch/"+this.props.watchDetail.slug+"/operations");
    }
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.setState({ isLoading: true, errors: [], }, ()=>{
                this.props.postWatchDeactivationDetail(
                    this.getPostData(),
    ...
    render() {
        ...
        return (
            <AdminWatchUnarchiveOperationComponent
                slug={slug}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postWatchDeactivationDetail: (postData, onSuccessCallback, onFailureCallback) => {
            dispatch(
                postWatchDeactivationDetail(postData, onSuccessCallback, onFailureCallback)
            )
        },
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchUnarchiveOperationContainer);
