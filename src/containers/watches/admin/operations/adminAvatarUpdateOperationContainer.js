...
import WatchAvatarUpdateOperationComponent from "../../../../components/watchs/admin/operations/adminAvatarUpdateOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postWatchAvatarCreateOrUpdateOperation } from "../../../../actions/watchActions";
import { validateImageInput } from "../../../../validators/fileValidator"


class AdminWatchAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Watch avatar has been successfully updated.");
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postWatchAvatarCreateOrUpdateOperation(
                this.getPostData(),
    ...
    render() {
        ...
        const watchFiles = this.props.watchFileList ? this.props.watchFileList.results : [];
        return (
            <WatchAvatarUpdateOperationComponent
                slug={slug}
                watch={watch}
...
const mapStateToProps = function(store) {
    return {
        ...
        watchFileList: store.watchFileListState,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postWatchAvatarCreateOrUpdateOperation: (postData, successCallback, failedCallback) => {
            dispatch(postWatchAvatarCreateOrUpdateOperation(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchAvatarUpdateOperationContainer);
