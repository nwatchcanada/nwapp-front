...
import AdminWatchCreateStep8Component from "../../../../components/watchs/admin/create/adminCreateStep8Component";
...
import { validateStep8CreateInput } from '../../../../validators/watchValidator';


class AdminWatchCreateStep8Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            organizationTypeOfLabel: localStorage.getItem("nwapp-create-watch-organizationTypeOfLabel"),
            ...
            streetNumber: localStorage.getItem("nwapp-create-watch-streetNumber"),
            streetName: localStorage.getItem("nwapp-create-watch-streetName"),
            streetType: localStorageGetIntegerItem("nwapp-create-watch-streetType"),
            streetTypeLabel: localStorage.getItem("nwapp-create-watch-streetTypeLabel"),
            streetTypeOption: localStorageGetObjectItem('nwapp-create-watch-streetTypeOption'),
            streetTypeOther: localStorage.getItem("nwapp-create-watch-streetTypeOther"),
            apartmentUnit: localStorage.getItem("nwapp-create-watch-apartmentUnit"),
            streetDirection: localStorageGetIntegerItem("nwapp-create-watch-streetDirection"),
            streetDirectionLabel: localStorage.getItem("nwapp-create-watch-streetDirectionLabel"),
            streetDirectionOption: localStorageGetObjectItem('nwapp-create-watch-streetDirectionOption'),
            postalCode: localStorage.getItem("nwapp-create-watch-postalCode"),
            country: localStorage.getItem("nwapp-create-watch-country"),
            region: localStorage.getItem("nwapp-create-watch-region"),
            locality: localStorage.getItem("nwapp-create-watch-locality"),
            ...
            typeOf: localStorageGetIntegerItem("nwapp-create-watch-typeOf"),
            tags: localStorageGetArrayItem("nwapp-create-watch-tags"),
            yearOfBirth: localStorage.getItem("nwapp-create-watch-yearOfBirth"),
            gender: localStorageGetIntegerItem("nwapp-create-watch-gender"),
            genderLabel: localStorage.getItem("nwapp-create-watch-gender-label"),
            howDidYouHearLabel: localStorage.getItem("nwapp-create-watch-howDidYouHearLabel"),
            howDidYouHear: localStorage.getItem("nwapp-create-watch-howDidYouHear"),
            howDidYouHearOption: localStorageGetObjectItem('nwapp-create-watch-howDidYouHearOption'),
            howDidYouHearOther: localStorage.getItem("nwapp-create-watch-howDidYouHearOther"),
            meaningLabel: localStorage.getItem("nwapp-create-watch-meaningLabel"),
            meaning: localStorage.getItem("nwapp-create-watch-meaning"),
            meaningOther: localStorage.getItem("nwapp-create-watch-meaningOther"),
            expectationLabel: localStorage.getItem("nwapp-create-watch-expectationLabel"),
            expectation: localStorage.getItem("nwapp-create-watch-expectation"),
            expectationOther: localStorage.getItem("nwapp-create-watch-expectationOther"),
            willingToVolunteerLabel: localStorage.getItem("nwapp-create-watch-willingToVolunteer-label"),
            willingToVolunteer: localStorageGetIntegerItem("nwapp-create-watch-willingToVolunteer"),
            anotherHouseholdWatchRegisteredLabel: localStorage.getItem("nwapp-create-watch-anotherHouseholdWatchRegistered-label"),
            anotherHouseholdWatchRegistered: localStorageGetIntegerItem("nwapp-create-watch-anotherHouseholdWatchRegistered"),
            totalHouseholdCount: localStorageGetIntegerItem("nwapp-create-watch-totalHouseholdCount"),
            under18YearsHouseholdCount: localStorageGetIntegerItem("nwapp-create-watch-under18YearsHouseholdCount"),
            organizationEmployeeCount: localStorageGetIntegerItem("nwapp-create-watch-organizationEmployeeCount"),
            organizationFoundingYear: localStorageGetIntegerItem("nwapp-create-watch-organizationFoundingYear"),
            errors: {},
            isLoading: false
        }
    ...
    getPostData() {
        ...
        postData.anotherHouseholdWatchRegistered = this.state.anotherHouseholdWatchRegistered === 1;
    ...
    onSuccessCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                localStorageRemoveItemsContaining("nwapp-create-watch-");
                this.props.setFlashMessage("success", "Watch has been successfully created.");
                this.props.history.push("/admin/watch/"+response['slug']);
            }
        )
    }
    ...
    render() {
        const {
            ...
            willingToVolunteerLabel, willingToVolunteer, anotherHouseholdWatchRegisteredLabel, anotherHouseholdWatchRegistered, totalHouseholdCount, under18YearsHouseholdCount,
            organizationEmployeeCount, organizationFoundingYear, organizationType, organizationTypeOfLabel, isLoading
        } = this.state;

        return (
            <AdminWatchCreateStep8Component
                typeOf={typeOf}
                ...
                anotherHouseholdWatchRegisteredLabel={anotherHouseholdWatchRegisteredLabel}
                anotherHouseholdWatchRegistered={anotherHouseholdWatchRegistered}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchCreateStep8Container);
