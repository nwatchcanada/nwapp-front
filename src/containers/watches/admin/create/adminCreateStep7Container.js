...
import AdminWatchCreateStep7Component from "../../../../components/watchs/admin/create/adminCreateStep7Component";
import { validateStep7CreateInput } from "../../../../validators/watchValidator";
import {
...
class AdminWatchCreateStep7Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            gender: localStorage.getItem("nwapp-create-watch-gender"),
            isHowHearLoading: true,
            howDidYouHear: localStorageGetIntegerItem("nwapp-create-watch-howDidYouHear"),
            ...
            meaning: localStorageGetIntegerItem("nwapp-create-watch-meaning"),
            meaningOther: localStorage.getItem("nwapp-create-watch-meaningOther"),
            isExpectationLoading: true,
            expectation: localStorageGetIntegerItem("nwapp-create-watch-expectation"),
            ...
            organizationEmployeeCount: localStorageGetIntegerItem("nwapp-create-watch-under18YearsHouseholdCount"),
    ...
    onSuccessfulSubmissionCallback(watch) {
        ...
        this.props.history.push("/admin/watchs/add/step-8");
    }
    ...
    onMultiChange(...args) {
        ...
        const key = 'nwapp-create-watch-' + args[1].name;
    ...
    render() {
        const {
            ...
            willingToVolunteer, anotherHouseholdWatchRegistered, totalHouseholdCount, under18YearsHouseholdCount,
        ...
        return (
            <AdminWatchCreateStep7Component
                typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminWatchCreateStep7Container);
