...
class AdminWatchCreateStep3Container extends Component {
    ...
    onRezOrComClick() {
        localStorage.setItem("nwapp-create-watch-typeOf", RESIDENCE_TYPE_OF);
        this.props.history.push("/admin/watchs/add/step-4");
    }

    onBizClick() {
        localStorage.setItem("nwapp-create-watch-typeOf", BUSINESS_TYPE_OF);
        this.props.history.push("/admin/watchs/add/step-4");
    }
