...
import AdminWatchMapComponent from "../../../../components/watches/admin/list/adminMapComponent";
...
class AdminWatchMapContainer extends Component {
    ...
    onTableChange(type, { sortField, sortOrder, data, page, sizePerPage, filters }) {
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullWatchList(page, sizePerPage, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onClick(event, slug) {
        ...
        this.props.history.push("/admin/watch/"+slug);
    }
