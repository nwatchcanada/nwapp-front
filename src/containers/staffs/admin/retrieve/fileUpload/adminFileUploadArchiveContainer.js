...
import StaffFileUploadArchiveComponent from "../../../../../components/staffs/admin/retrieve/fileUpload/adminFileUploadArchiveComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { deletePrivateFileUpload } from "../../../../../actions/privateFileUploadActions";


class AdminStaffFileUploadArchiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.history.push("/admin/staff/"+this.state.slug+"/files");
            }
        )
    }
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffFileUploadArchiveContainer);
