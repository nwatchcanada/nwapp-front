...
import AdminStaffFileUploadListComponent from "../../../../../components/staffs/admin/retrieve/fileUpload/adminFileUploadListComponent";
...
class AdminStaffFileUploadListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminStaffFileUploadListComponent
                slug={slug}
                staff={staff}
...
const mapStateToProps = function(store) {
    return {
        ...
        staffFileList: store.privateFileUploadListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffFileUploadListContainer);
