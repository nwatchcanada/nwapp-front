...
class AdminStaffFileUploadAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Staff file has been successfully created.");
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffFileUploadAddContainer);
