...
import AdminStaffFullRetrieveComponent from "../../../../components/staffs/admin/retrieve/adminFullRetrieveComponent";
...
class AdminStaffFullRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminStaffFullRetrieveComponent
                slug={slug}
                staff={staff}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffFullRetrieveContainer);
