...
import AdminStaffCreateStep6Component from "../../../../components/staffs/admin/create/adminCreateStep6Component";
...
class AdminStaffCreateStep6Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onTableRowClick(e, typeOf, slug, icon, name) {
        ...
        localStorage.setItem('nwapp-create-staff-watch-typeOf', typeOf);
        localStorage.setItem('nwapp-create-staff-watch-slug', slug);
        localStorage.setItem('nwapp-create-staff-watch-icon', icon);
        localStorage.setItem('nwapp-create-staff-watch-name', name);
        this.props.history.push("/admin/staffs/add/step-7");
    }
    ...
    render() {
        ...
        return (
            <AdminStaffCreateStep6Component
                tableData={tableData}
                returnURL={returnURL}
                isLoading={isLoading}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffCreateStep6Container);
