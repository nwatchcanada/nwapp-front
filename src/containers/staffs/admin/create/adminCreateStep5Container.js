...
import AdminStaffCreateStep5Component from "../../../../components/staffs/admin/create/adminCreateStep5Component";
import {
...
class AdminStaffCreateStep5Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessfulSubmissionCallback(staff) {
        ...
        this.props.history.push("/admin/staffs/add/step-6");
    }
    ...
    render() {
        ...
        return (
            <AdminStaffCreateStep5Component
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffCreateStep5Container);
