...
import AdminStaffUnarchiveOperationComponent from "../../../../components/staffs/admin/operations/adminUnarchiveOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postStaffDeactivationDetail } from "../../../../actions/staffActions";
import { validateActivationInput } from "../../../../validators/staffValidator";


class AdminStaffUnarchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessCallback(response) {
        ...
        this.props.setFlashMessage("success", "Staff has been successfully activated.");
    ...
    render() {
        ...
        return (
            <AdminStaffUnarchiveOperationComponent
                slug={slug}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffUnarchiveOperationContainer);
