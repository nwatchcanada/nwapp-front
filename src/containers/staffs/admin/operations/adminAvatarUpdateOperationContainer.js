...
import StaffAvatarUpdateOperationComponent from "../../../../components/staffs/admin/operations/adminAvatarUpdateOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postStaffAvatarCreateOrUpdateOperation } from "../../../../actions/staffActions";
import { validateImageInput } from "../../../../validators/fileValidator"


class AdminStaffAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Staff avatar has been successfully updated.");
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postStaffAvatarCreateOrUpdateOperation(
                this.getPostData(),
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postStaffAvatarCreateOrUpdateOperation: (postData, successCallback, failedCallback) => {
            dispatch(postStaffAvatarCreateOrUpdateOperation(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffAvatarUpdateOperationContainer);
