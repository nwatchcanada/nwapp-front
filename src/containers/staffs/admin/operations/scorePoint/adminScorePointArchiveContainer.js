...
import AdminStaffScorePointArchiveComponent from "../../../../../components/staffs/admin/operations/scorePoint/adminScorePointArchiveComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { deleteScorePoint } from "../../../../../actions/scorePointActions";


class AdminStaffScorePointArchiveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminStaffScorePointArchiveComponent
                slug={slug}
                staff={staff}
                isLoading={isLoading}
                errors={errors}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffScorePointArchiveContainer);
