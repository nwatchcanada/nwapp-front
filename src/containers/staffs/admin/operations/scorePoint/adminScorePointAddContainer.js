...
import OrderListComponent from "../../../../../components/staffs/admin/operations/scorePoint/adminScorePointAddComponent";
import { setFlashMessage } from "../../../../../actions/flashMessageActions";
import { postScorePoint } from "../../../../../actions/scorePointActions";
import { validateScorePointInput } from "../../../../../validators/staffValidator"
import { getTagReactSelectOptions, pullTagList } from "../../../../../actions/tagActions";


class AdminStaffScorePointAddContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Score has been successfully added to staff.");
                this.props.history.push("/admin/staff/"+this.state.slug+"/community/score-points");
            }
        )
    }
...
const mapStateToProps = function(store) {
    return {
        ...
        staffFileList: store.scorePointListState,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffScorePointAddContainer);
