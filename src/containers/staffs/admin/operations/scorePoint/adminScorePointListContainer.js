...
import AdminStaffScorePointListComponent from "../../../../../components/staffs/admin/operations/scorePoint/adminScorePointListComponent";
...
class AdminStaffScorePointListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminStaffScorePointListComponent
                slug={slug}
                staff={staff}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffScorePointListContainer);
