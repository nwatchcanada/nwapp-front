...
import StaffPromoteStep3Component from "../../../../components/staffs/admin/operations/adminPromoteOperationStep3Component";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { postStaffPromoteOperation } from "../../../../actions/staffActions";
import {
...
class AdminStaffPromoteOperationStep2Container extends Component {
    ...
    onClick(e) {
        ...
        this.props.postStaffPromoteOperation(
            this.getPostData(),
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postStaffPromoteOperation: (postData, successCallback, failedCallback) => {
            dispatch(postStaffPromoteOperation(postData, successCallback, failedCallback))
        },
    }
}
