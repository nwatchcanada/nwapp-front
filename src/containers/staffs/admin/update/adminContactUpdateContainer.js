...
import AdminStaffContactUpdateComponent from "../../../../components/staffs/admin/update/adminContactUpdateComponent";
...
class AdminStaffContactUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            firstName: this.props.staffDetail.firstName,
            lastName: this.props.staffDetail.lastName,
            organizationName: this.props.staffDetail.organizationName,
            organizationTypeOf: this.props.staffDetail.organizationTypeOf,
            firstName: this.props.staffDetail.firstName,
            lastName: this.props.staffDetail.lastName,
            primaryPhone: this.props.staffDetail.primaryPhoneNational,
            primaryPhoneTypeOf: this.props.staffDetail.primaryPhoneTypeOf,
            secondaryPhone: this.props.staffDetail.secondaryPhoneNational,
            secondaryPhoneTypeOf: this.props.staffDetail.secondaryPhoneTypeOf,
    ...
    render() {
        ...
        return (
            <AdminStaffContactUpdateComponent
                // STEP 3
                typeOf={typeOf}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffContactUpdateContainer);
