...
import AdminStaffMetricUpdateComponent from "../../../../components/staffs/admin/update/adminMetricsUpdateComponent";
...
class AdminStaffMetricUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        const transcodedTags = getPickedTagReactSelectOptions(this.props.staffDetail.tags, this.props.tagList)
        const anotherHouseholdMemberRegistered = this.props.staffDetail.anotherHouseholdMemberRegistered === true ? 1 : 0;
        ...
        this.state = {
            ...
            isTagsLoading: true,
            tags: transcodedTags,
            yearOfBirth: this.props.staffDetail.yearOfBirth,
            gender: this.props.staffDetail.gender,
            isHowHearLoading: true,
            howDidYouHear: this.props.staffDetail.howDidYouHear,
            // howDidYouHearOption: localStorageGetObjectItem('nwapp-create-staff-howDidYouHearOption'),
            howDidYouHearOther: this.props.staffDetail.howDidYouHearOther,
            isMeaningLoading: true,
            meaning: this.props.staffDetail.meaning,
            meaningOther: this.props.staffDetail.meaningOther,
            isExpectationLoading: true,
            expectation: this.props.staffDetail.expectation,
            expectationOther: this.props.staffDetail.expectationOther,
            willingToVolunteer: this.props.staffDetail.willingToVolunteer,
            anotherHouseholdMemberRegistered: anotherHouseholdMemberRegistered,
            totalHouseholdCount: this.props.staffDetail.totalHouseholdCount,
            over18YearsHouseholdCount: this.props.staffDetail.over18YearsHouseholdCount,
            organizationEmployeeCount: this.props.staffDetail.organizationEmployeeCount,
            organizationFoundingYear: this.props.staffDetail.organizationFoundingYear,
    ...
    getPostData() {
        ...
        // BUGFIX: Set year of birth to be zero if not entered.
        if (this.state.yearOfBirth == undefined || this.state.yearOfBirth == null || this.state.yearOfBirth == "") {
    ...
    render() {
        ...
        return (
            <AdminStaffMetricUpdateComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminStaffMetricUpdateContainer);
